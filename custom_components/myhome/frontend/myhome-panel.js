...
`,Ge=(o,e)=>{let{i18n:t}=e,r=o.covers.length===1?t.t("panel.overview.count_one"):t.t("panel.overview.count_other",{count:o.covers.length});return s`<section class="group" data-group=${o.key??"none"} aria-labelledby=${o.id}>
  ...
  </section>`};var U="/config/integrations/integration/myhome",J=class extends v{static{this.properties={i18n:{attribute:!1},overview:{attribute:!1},search:{type:String},room:{type:String}}}constructor(){super(),this.i18n=new _,this.overview=null,this.search="",this.room=""}static{this.styles=[E,A,P,K,je,qe,Ve,h`
      :host {
        display: block;
        background: transparent;
      }
...
`;var Y=class extends v{constructor(){super();this._fire=(t,r)=>{this.dispatchEvent(new CustomEvent("myhome-screen-action",{detail:{action:t,value:r,screen:this.model?.id??""},bubbles:!0,composed:!0}))};this.model=null,this.i18n=new _}static{this.properties={model:{attribute:!1},i18n:{attribute:!1}}}static{this.styles=[E,A,P,K,X,rt,h`
      :host {
        display: block;
        background: transparent;
      }
    ...
    </div>`}};customElements.get("myhome-screen")||customElements.define("myhome-screen",Y);var wt=3e4,he=class extends v{constructor(){super();this._i18n=new _;this._router=new V;this._store=new G(this._router.current);this._unsubscribeStore=null;this._unsubscribeWs=null;this._poll=null;this._language="";this._started=!1;this._onReturn=()=>{!this._started||document.hidden||this._refresh()};this.narrow=!1,this.panel=null}static{this.properties={hass:{attribute:!1},narrow:{type:Boolean},route:{attribute:!1},panel:{attribute:!1}}}static{this.styles=[E,A,P,X,We,h`
      .toolbar {
        display: flex;
        align-items: center;
        gap: 8px;
