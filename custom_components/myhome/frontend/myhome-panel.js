...
`);if(a.every(dr)){e.push(s`<ul>
  ...
  >`};var _t=u`.row{position:relative;display:flex;align-items:flex-start;gap:8px;padding:8px;border-radius:8px;min-height:48px;-webkit-user-select:none;-webkit-touch-callout:none}.row .divider{position:absolute;left:8px;right:8px;top:-1px;height:1px;background:var(--myhome-divider);opacity:.6;pointer-events:none}.row .insert-line{position:absolute;left:8px;right:8px;top:-2px;height:3px;border-radius:2px;background:var(--myhome-primary);pointer-events:none}.row .pending-outline{position:absolute;inset:0;border:2px dashed var(--myhome-primary);border-radius:8px;pointer-events:none}.row .source-veil{position:absolute;inset:0;background:var(--myhome-background-soft);opacity:.7;border-radius:8px;pointer-events:none}.row .handle{width:48px;height:48px;flex:0 0 48px;border:none;background:transparent;color:var(--myhome-text-soft);cursor:grab;font-size:18px;letter-spacing:2px;border-radius:8px;touch-action:none;-webkit-user-select:none;user-select:none}.row .handle[disabled]{cursor:default;color:var(--myhome-text-off)}@media(max-width:599px){.row .handle{position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;clip-path:inset(50%);white-space:nowrap}.row .handle:focus-visible{position:static;width:48px;height:48px;margin:0;overflow:visible;clip-path:none}}.row .main{flex:1 1 auto;min-width:0;text-align:left;border:none;background:transparent;color:inherit;font:inherit;cursor:pointer;padding:2px 0;border-radius:6px}.row .name{display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden;font-size:14.5px;line-height:1.35}.row .sub{display:block;font-size:12.5px;color:var(--myhome-text-soft);margin-top:2px}.row .chips{display:flex;gap:6px;flex-wrap:wrap;margin-top:6px;align-items:center}.row .warn{display:block;font-size:12.5px;color:var(--myhome-warning);margin-top:4px}.route{display:inline-flex;align-items:center;gap:2px;font-size:12px;color:var(--myhome-primary);background:var(--myhome-primary-faint);border:1px dashed var(--myhome-primary);border-radius:10px;padding:2px 2px 2px 8px;max-width:100%}.route .text{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.route .withdraw{width:48px;height:48px;margin:-14px -14px -14px 0;display:inline-flex;align-items:center;justify-content:center;border:none;background:transparent;color:inherit;font:inherit;font-size:14px;line-height:1;cursor:pointer;border-radius:24px}.row .note{display:block;font-size:12.5px;color:var(--myhome-info);margin-top:4px}`,fr=(n,t,e)=>{let r=t.height!==null?n.t("panel.overview.cover.travel",{travel:n.number(t.height,0)}):e?n.t("panel.overview.cover.travel_needed"):n.t("panel.overview.cover.travel_unknown");return t.area?`${t.area} · ${r}`:r},_r=(n,t)=>t.has_own.length===0?"":X.every(e=>t.has_own.includes(e))?n.t("panel.assign.pending.all_own"):n.t("panel.assign.pending.some_own"),yt=(n,t)=>{let{i18n:e,pending:r}=t,o=!!r&&r.to!==null&&n.height===null,i=r?_r(e,n):"";return s`<div class="row" data-row=${n.unique_id}>
    ...
    <button
      ...
      title=${n.name}
      @click=${()=>t.onOpen(n)}
      @pointerdown=${a=>t.onRowPress(n,a)}
    >
      <span class="name">${n.name}</span>
      <span class="sub">${fr(e,n,o)}</span>
      <span class="chips">
        ${ft(e,n.origin,n.profile,t.short)}
  ...
  >
    ...
    >
      ...
      <div class="options">
        ${n.profiles.map(r=>e(r.name,t.t("panel.dialog.option.profile",{profile:r.name}),yr(t,r)))}
  ...
  >
    ...
    >
      ...
      <div class="body">
        ...
        ${r.map(({change:p,cover:d})=>{let c=e.get(p.cover),m=n.heights[p.cover],h=p.to!==null&&d.height===null,g=h?F(m):null,v=g!==null&&(n.forced||(m??"")!==""),$=c&&c.problem===null?i.filter(f=>c.values[f]!==void 0&&d.values[f]!==void 0):[];return s`<section class="item">
            <div class="line">
            ...
            ${h?s`<label class="travel">
                  ...
                  ${v?s`<p class="field-error">
                        ${g==="missing_travel"?t.t("panel.review.travel.required"):Rt(t,d,g,p)}
                      </p>`:l}`:l}
            ...
            ${(()=>{let f=br(t,d,p,c,n.profiles);return f?s`<p class="note">${f}</p>`:l})()}
          </section>`})}
  ...
  `};var Pt=u`.strip{position:fixed;left:50%;bottom:calc(16px + env(safe-area-inset-bottom,0px));transform:translate(-50%);max-width:92vw;box-sizing:border-box;box-shadow:var(--myhome-shadow)}.drop-zone{z-index:45;padding:14px 28px;min-height:48px;display:flex;align-items:center;border-radius:24px;font-size:14px;font-weight:500;border:2px dashed var(--myhome-divider);background:var(--myhome-card);color:var(--myhome-text-soft)}.drop-zone.over{border:2px solid var(--myhome-primary);color:var(--myhome-primary)}.dark{background:var(--myhome-text);color:var(--myhome-background);border-radius:8px;font-size:14px}.armed{z-index:40;bottom:calc(84px + env(safe-area-inset-bottom,0px));padding:10px 16px;display:flex;gap:16px;align-items:center}.applying{z-index:70;padding:12px 20px}.applying .under{display:block;font-size:12px;opacity:.75;margin-top:2px}.snack{z-index:70;padding:8px 8px 8px 20px;display:flex;align-items:center;gap:8px}.dark button{min-height:44px;padding:0 12px;border:none;background:transparent;color:var(--myhome-snack-action);font:inherit;font-weight:500;cursor:pointer}.pending-bar{z-index:30;background:var(--myhome-card);border:1px solid var(--myhome-divider);border-radius:28px;padding:8px 8px 8px 20px;display:flex;align-items:center;gap:12px;flex-wrap:wrap}.pending-bar .count{font-size:14px}.pending-bar .locked{font-size:13px;color:var(--myhome-warning);flex-basis:100%}.pending-bar button{min-height:44px;border:none;font:inherit;font-size:14px;cursor:pointer}.pending-bar .discard{padding:0 12px;background:transparent;color:var(--myhome-text-soft)}.pending-bar .review{padding:0 20px;border-radius:22px;background:var(--myhome-primary);color:var(--myhome-text-on-primary);font-weight:500}.pending-bar button[disabled]{color:var(--myhome-text-off);background:var(--myhome-background-soft);cursor:default}@media(max-width:599px){.strip.pending-bar{left:8px;right:8px;transform:none;max-width:none;justify-content:space-between}.strip.pending-bar .count{flex-basis:100%}}`,Ct=(n,t)=>s`<div class="strip drop-zone ${t?"over":""}" data-group="none">
    ...
    ${e?s`<button type="button" @click=${e}>
    ...
    </section>`}_renderStrips(){let e=this.state;if(e.drag)return Ct(this.i18n,e.drag.over==="none");if(e.armed){let r=this._cover(e.armed);return Tt(this.i18n,r?.name??"",()=>this.actions.arm(null))}return e.applying?Mt(this.i18n):e.snack?Lt(this.i18n,e.snack.message,e.snack.undoToken?()=>this.actions.undo():null):e.pending.length>0&&!e.review?At({i18n:this.i18n,count:e.pending.length,locked:this._locked,lockedCover:this._overview?.measuring?.name??"",onDiscard:()=>{this._beforeMove(),this.actions.discardAll()},onReview:()=>this.actions.review(!0)}):l}_renderDialog(){let e=this.state.dialog?this._cover(this.state.dialog):void 0;return e?wt({i18n:this.i18n,cover:e,profiles:this._overview?.profiles??[],current:we(e,this.state.pending),onPick:r=>{this._beforeMove(),this.actions.assign(e,r)},onClose:()=>this.actions.dialog(null)}):l}_renderReview(){let e=this._overview;return!this.state.review||!e?l:Et({i18n:this.i18n,pending:this.state.pending,covers:new Map(e.covers.map(r=>[r.unique_id,r])),profiles:new Map(e.profiles.map(r=>[r.name,r])),preview:this.state.preview,heights:this.state.heights,forced:this.state.heightsForced,showAll:this.state.showAll,applying:this.state.applying,refusal:this.state.writeError?this.i18n.refusal(this.state.writeError.translation_key,this.state.writeError.translation_placeholders??{}):"",route:this._route,onHeight:(r,o)=>this.actions.height(r,o),onToggleShowAll:()=>this.actions.toggleShowAll(),onConfirm:()=>this.actions.confirm(),onClose:()=>this.actions.review(!1)})}render(){let e=this._overview;if(!e)return s`<p>${this.i18n.t("panel.common.loading")}</p>`;if(e.no_basic_covers)return s`<div class="card notice">
        ${T(this.i18n.t("panel.overview.no_basic_covers"))}
      ...
      ${o===0&&i?s`<div class="card notice">
            ...
            ${r.map(p=>{let d=Ee(p.key),c=a?.insert??null,m=c!==null&&c.group===d;return kt(p,{i18n:this.i18n,pending:this.state.pending,route:this._route,locked:this._locked,collapsed:this.state.armed!==null,over:a?.over===d,insertBefore:m?c.beforeId:null,insertEnd:m?c.end||c.afterId===p.covers.at(-1)?.unique_id:!1,dragging:a?.cover??null,onOpenProfile:h=>this.actions.openProfile(h),onOpenCover:h=>this.actions.openCover(h.unique_id),onGrab:this._onGrab,onRowPress:this._onRowPress,onPick:h=>this.actions.dialog(h),onWithdraw:h=>{this._beforeMove(),this.actions.withdraw(h)},onTarget:h=>{let g=this.state.armed?this._cover(this.state.armed):void 0;g&&(this._beforeMove(),this.actions.assign(g,h))}})})}
          </div>`}
      ${this._renderStrips()} ${this._renderDialog()} ${this._renderReview()}
    `}};customElements.get("myhome-overview")||customElements.define("myhome-overview",re);var It={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Ot=n=>(...t)=>({_$litDirective$:n,values:t}),ne=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,r){this._$Ct=t,this._$AM=e,this._$Ci=r}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}};var zt="important",wr=" !"+zt,Ht=Ot(class extends ne{constructor(n){if(super(n),n.type!==It.ATTRIBUTE||n.name!=="style"||n.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(n){return Object.keys(n).reduce((t,e)=>{let r=n[e];return r==null?t:t+`${e=e.includes("-")?e:e.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${r};`},"")}update(n,[t]){let{style:e}=n.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(let r of this.ft)t[r]==null&&(this.ft.delete(r),r.includes("-")?e.removeProperty(r):e[r]=null);for(let r in t){let o=t[r];if(o!=null){this.ft.add(r);let i=typeof o=="string"&&o.endsWith(wr);r.includes("-")||i?e.setProperty(r,i?o.slice(0,-11):o,i?zt:""):e[r]=o}}return b}});var Dt=(n,t)=>n.summary?.note?s`<div class="stub">${n.summary.note}</div>`:l;var Nt=(n,t)=>{let e=n.options??[];return e.length===0?l:s`<div class="options" role="group" aria-label=${n.title}>
    ${e.map(r=>s`<button
        class="option"
        type="button"
  ...
  </div>`};var Ut=(n,t)=>{let e=n.progress;if(!e)return s`<div class="stub">${t.i18n.t("panel.screen.not_in_this_version")}</div>`;let r=Math.max(0,Math.min(1,e.fraction))*100;return s`<div class="progress-card">
  ...
  </div>`};var qt=(n,t)=>{let e=n.press;if(!e)return s`<div class="stub">${t.i18n.t("panel.screen.not_in_this_version")}</div>`;let r=e.state==="moving";return s`
  ...
  `};var Ft=(n,t)=>{let e=n.options??[];if(e.length===0&&!n.field)return s`<div class="stub">${t.i18n.t("panel.screen.not_in_this_version")}</div>`;let r=n.field;return s`
  ...
  `};var Wt=(n,t)=>{let e=n.field;return e?s`<div class="reading ${e.big===!1?"":"big"}">
  ...
  </div>`:s`<div class="stub">${t.i18n.t("panel.screen.not_in_this_version")}</div>`};var Bt=(n,t)=>{let e=n.summary;return e?s`
    <div class="summary">
  ...
  `:s`<div class="stub">${t.i18n.t("panel.screen.not_in_this_version")}</div>`};var Gt=(n,t)=>n.summary?.rows?.length?s`<div class="summary">
    ...
    </div>`}render(){let e=this.model;if(!e)return l;let r={i18n:this.i18n,fire:this._fire},o=e.model==="pos",i=e.image?kr(e.image):null;return s`<div class="screen">
      <main class=${o?"single":""}>
    ...
    ></myhome-screen>`}get _locked(){let e=this._store.state;return e.overview?.measuring!=null||e.applying}async _confirm(){let e=this._store.state,r=e.entryId;if(this._locked||!r||e.pending.length===0)return;if(e.pending.filter(p=>{let d=e.overview?.covers.find(c=>c.unique_id===p.cover);return d!==void 0&&at(d,p)&&F(e.heights[p.cover])!==null}).length>0){this._store.set({heightsForced:!0}),this._store.announce(this._i18n.t("panel.assign.announce.missing_travel"));return}let i=xe(e.pending,e.heights),a=e.order??void 0;this._store.announce(this._i18n.t("panel.assign.announce.applying")),await this._write(()=>Je(this.hass.connection,r,i,a),p=>{this._store.set({...Se}),this._store.setOverview(p.overview),this._snack(p.applied===1?this._i18n.t("panel.toast.assigned_one"):this._i18n.t("panel.toast.assigned",{count:p.applied}),p.undo_token)})}async _undo(){let e=this._store.state,r=e.snack?.undoToken;if(!r||!e.entryId)return;let o=e.entryId;this._clearSnack(),await this._write(()=>et(this.hass.connection,o,r),i=>{this._store.setOverview(i.overview),this._snack(this._i18n.t("panel.toast.undone"),null)})}async _write(e,r,o){this._store.set({applying:!0,writeError:null});try{let i=await e();this._store.set({applying:!1}),r(i)}catch(i){let a=A(i);this._store.set({applying:!1,writeError:a});let p=this._i18n.refusal(a.translation_key,a.translation_placeholders??{});this._store.announce(p),o?.(p)}}_snack(e,r,o=!0){this._clearSnack(),this._store.set({snack:{message:e,undoToken:r}}),o&&this._store.announce(e),this._snackTimer=setTimeout(()=>{this._snackTimer=null,this._store.set({snack:null})},Sr)}_clearSnack(){this._snackTimer&&(clearTimeout(this._snackTimer),this._snackTimer=null),this._store.set({snack:null})}_schedulePreview(){this._store.state.review&&(this._previewTimer&&clearTimeout(this._previewTimer),this._previewTimer=setTimeout(()=>{this._previewTimer=null,this._refreshPreview()},Er))}async _refreshPreview(){let e=this._store.state;if(!e.entryId||e.pending.length===0){this._store.set({preview:null});return}let r=++this._previewSeq;this._store.set({previewing:!0});try{let o=await Ye(this.hass.connection,e.entryId,xe(e.pending,e.heights));r===this._previewSeq&&this._store.set({preview:o.items,previewing:!1})}catch(o){r===this._previewSeq&&this._store.set({previewing:!1}),ye(o)||console.warn("MyHOME panel: the preview could not be read",A(o))}}_renderView(){let e=this._store.state;if(e.status==="loading")return s`<div class="card waiting" role="status">
    ...
    ></myhome-overview>`}render(){let e=this._store.state,r=this._i18n.t("panel.overview.title"),o=e.overview?.entries.find(a=>a.entry_id===e.entryId),i=e.overview?.measuring??null;return s`
      ...
      ${i?ut(this._i18n,i.name,E):l}
      <div class="content">
        ${ct(e.announce)} ${this._renderView()}
