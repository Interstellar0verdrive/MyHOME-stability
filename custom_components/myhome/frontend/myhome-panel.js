...
`);if(a.every(dr)){e.push(s`<ul>
  ...
  >
    ...
    >
      ...
      <div class="body">
        ...
        ${r.map(({change:p,cover:d})=>{let c=e.get(p.cover),m=n.heights[p.cover],h=p.to!==null&&d.height===null,g=h?q(m):null,v=g!==null&&(n.forced||(m??"")!==""),$=c&&c.problem===null?i.filter(f=>c.values[f]!==void 0&&d.values[f]!==void 0):[];return s`<section class="item">
            <div class="line">
  ...
  `:s`<div class="stub">${t.i18n.t("panel.screen.not_in_this_version")}</div>`};var Gt=(n,t)=>n.summary?.rows?.length?s`<div class="summary">
    ...
    `}};customElements.get("myhome-calibration-panel")||customElements.define("myhome-calibration-panel",Ee);export{Ee as MyHomeCalibrationPanel};
