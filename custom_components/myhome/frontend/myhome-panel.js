...
`;var ct=n=>s`<div class="sr-only" role="status" aria-live="polite" aria-atomic="true">${n}</div>`,mr=n=>{requestAnimationFrame(()=>{let t=n();t&&t.focus()})};var ee=class{constructor(){this._root=null;this._onKey=t=>{if(t.key!=="Tab"||!this._root)return;let e=dt(this._root);if(e.length===0){t.preventDefault(),this._root.focus();return}let r=e[0],o=e[e.length-1],i=this._root.getRootNode().activeElement;t.shiftKey&&(i===r||i===this._root)?(t.preventDefault(),o.focus()):!t.shiftKey&&i===o&&(t.preventDefault(),r.focus())}}hold(t){this.release(),this._root=t,t.addEventListener("keydown",this._onKey),mr(()=>dt(t)[0]??t)}release(){this._root?.removeEventListener("keydown",this._onKey),this._root=null}},dt=n=>Array.from(n.querySelectorAll('a[href], button:not([disabled]), input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])')).filter(t=>t.offsetParent!==null||t===n);var ht=u`
  .measuring {
    max-width: 1200px;
    margin: 16px auto 0;
    padding: 12px 16px;
...
`,ut=(n,t,e)=>s`<div class="measuring" role="status" aria-live="polite">
...
`,ft=(n,t,e,r)=>{let o=t==="measured"?"measured":t==="adjusted"?"adjusted":"neutral",i;return r&&t==="inherited"?i=n.t("panel.overview.cover.origin_inherited"):r&&t==="adjusted"?i=n.t("panel.overview.cover.origin_adjusted"):i=n.origin(t,e),s`<span class="chip ${o}"
...
`,yr=(n,t)=>t.missing||t.values.opening_time===void 0?n.t("panel.overview.group.values_unknown"):n.t("panel.dialog.option.profile_meta",{travel:t.reference_height===null?"?":n.number(t.reference_height,0),opening:n.number(t.values.opening_time,1),closing:n.number(t.values.closing_time,1)}),bt=n=>{let{i18n:t}=n,e=(r,o,i)=>s`<button
...
`,Pe=n=>n===null?"none":`profile:${n}`,$t=n=>n==="none"?null:n.slice(8),kt=(n,t)=>{let{i18n:e}=t,r=n.covers.length===1?e.t("panel.overview.group.count_one"):e.t("panel.overview.group.count",{count:n.covers.length}),o=t.collapsed;return s`<section
    ...
    >
      ...
      <div class="body">
        ...
        ${r.map(({change:p,cover:d})=>{let c=e.get(p.cover),m=n.heights[p.cover],h=p.to!==null&&d.height===null,g=h?q(m):null,v=g!==null&&(n.forced||(m??"")!==""),$=c&&c.problem===null?i.filter(f=>c.values[f]!==void 0&&d.values[f]!==void 0):[];return s`<section class="item">
            ...
            ${(()=>{let f=_r(t,d,p,c,n.profiles);return f?s`<p class="note">${f}</p>`:l})()}
          </section>`})}
...
`,Ct=(n,t)=>s`<div class="strip drop-zone ${t?"over":""}" data-group="none">
    ...
    `]}connectedCallback(){super.connectedCallback(),window.addEventListener("keydown",this._onKey)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this._onKey),this._drag.stop(),this._trap.release()}updated(e){if(e.has("state")){let r=e.get("state");if(this._manageFocus(r),this._flip){let o=this._flip;this._flip=null,requestAnimationFrame(()=>gt(this.renderRoot,o))}}}_beforeMove(){this._flip=mt(this.renderRoot)}_manageFocus(e){let r=this.state.dialog!==null||this.state.review,o=(e?.dialog??null)!==null||(e?.review??!1);if(r&&!o){let i=this._activeElement();this._returnTo=i,this._returnToRow=i?.closest("[data-row]")?.getAttribute("data-row")??null,requestAnimationFrame(()=>{let a=this.renderRoot.querySelector("[data-focus-root]");a&&this._trap.hold(a)});return}if(!r&&o){this._trap.release();let i=this._returnTo,a=this._returnToRow;this._returnTo=null,this._returnToRow=null,requestAnimationFrame(()=>{((a?this.renderRoot.querySelector(`[data-row="${CSS.escape(a)}"] .handle`):null)??(i?.isConnected?i:null))?.focus()})}}_activeElement(){let e=this.renderRoot.activeElement;return e instanceof HTMLElement?e:null}get _overview(){return this.state.overview}get _locked(){return this._overview?.measuring!=null||this.state.applying}get _narrow(){return typeof matchMedia=="function"&&matchMedia("(max-width: 599px)").matches}_cover(e){return this._overview?.covers.find(r=>r.unique_id===e)}get _covers(){let e=this._overview;return e?ot(e,this.state.order):[]}get _rooms(){let e=new Set;for(let r of this._overview?.covers??[])r.area&&e.add(r.area);return Array.from(e).sort((r,o)=>r.localeCompare(o,this.i18n.language))}_matches(e){let r=this.state.search.trim().toLowerCase();return r&&!e.name.toLowerCase().includes(r)?!1:!this.state.room||e.area===this.state.room}_groupName(e){return e===null?this.i18n.t("panel.overview.group.no_profile"):this.i18n.t("panel.overview.group.profile",{profile:e})}_valuesLine(e){return e.missing||!e.values||e.values.opening_time===void 0?this.i18n.t("panel.overview.group.values_unknown"):this.i18n.t("panel.overview.group.values",{travel:e.reference_height===null?"?":this.i18n.number(e.reference_height,0),opening:this.i18n.number(e.values.opening_time,1),closing:this.i18n.number(e.values.closing_time,1),slat:this.i18n.number(e.values.slat_time,1)})}_provenanceLine(e){if(e.source==="yaml")return this.i18n.t("panel.overview.group.from_file");if(!e.measured_on)return this.i18n.t("panel.overview.group.provenance_missing");let r=e.measured_at?this.i18n.date(e.measured_at):"";if(!e.measured_on_name)return this.i18n.t("panel.overview.group.measured_on_gone",{date:r});let o=this.i18n.t("panel.overview.group.measured_on",{cover:e.measured_on_name,date:r}),i=(this._overview?.covers??[]).find(a=>a.unique_id===e.measured_on);if(i&&i.profile!==e.name){let a=i.profile??this.i18n.t("panel.overview.group.no_profile");o+=` · ${this.i18n.t("panel.profile.provenance_now_profile",{profile:a})}`}return o}get _groups(){let e=this._overview;if(!e)return[];let r=this._covers,o=a=>r.filter(p=>be(p,this.state.pending)===a&&this._matches(p)),i=e.profiles.map((a,p)=>({key:a.name,id:`group-${p}`,title:this.i18n.t("panel.overview.group.profile",{profile:a.name}),values:this._valuesLine(a),provenance:this._provenanceLine(a),warning:a.missing?this.i18n.t("panel.overview.group.missing"):"",covers:o(a.name)}));return i.push({key:null,id:"group-none",title:this.i18n.t("panel.overview.group.no_profile"),values:this.i18n.t("panel.overview.group.no_profile_note"),provenance:"",warning:"",covers:o(null)}),i}_endDrag(e){let r=this.state,o=r.drag,i=o?.insert??null,a=o?.over??null,p=o?this._cover(o.cover):void 0;if(this.actions.drag(null),!e||!p||a===null){o&&this.actions.announce(this.i18n.t("panel.assign.announce.drag_cancelled"));return}let d=$t(a),c=this._covers.map(v=>v.unique_id),m=it(c,p.unique_id,i??{beforeId:null,afterId:null});this._beforeMove();let h=V(p.unique_id,r.pending),g=h?h.to:p.profile??null;if(d!==g){this.actions.setOrder(m),this.actions.assign(p,d);return}if(r.pending.length>0){this.actions.setOrder(m),this.actions.announce(this.i18n.t("panel.assign.announce.reordered"));return}this.actions.reorder(m)}_renderControls(){return s`<div class="controls">
      ...
      <a class="cta secondary compact" href=${B} title=${this.i18n.t("panel.firstrun.note")}
    ...
    `}};customElements.get("myhome-overview")||customElements.define("myhome-overview",re);var Lt={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Ot=n=>(...t)=>({_$litDirective$:n,values:t}),ne=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,r){this._$Ct=t,this._$AM=e,this._$Ci=r}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}};var zt="important",br=" !"+zt,Ht=Ot(class extends ne{constructor(n){if(super(n),n.type!==Lt.ATTRIBUTE||n.name!=="style"||n.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(n){return Object.keys(n).reduce((t,e)=>{let r=n[e];return r==null?t:t+`${e=e.includes("-")?e:e.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${r};`},"")}update(n,[t]){let{style:e}=n.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(let r of this.ft)t[r]==null&&(this.ft.delete(r),r.includes("-")?e.removeProperty(r):e[r]=null);for(let r in t){let o=t[r];if(o!=null){this.ft.add(r);let i=typeof o=="string"&&o.endsWith(br);r.includes("-")||i?e.setProperty(r,i?o.slice(0,-11):o,i?zt:""):e[r]=o}}return _}});var Dt=(n,t)=>n.summary?.note?s`<div class="stub">${n.summary.note}</div>`:l;var Nt=(n,t)=>{let e=n.options??[];return e.length===0?l:s`<div class="options" role="group" aria-label=${n.title}>
    ${e.map(r=>s`<button
        class="option"
        type="button"
  ...
  `};var Bt=(n,t)=>{let e=n.options??[];if(e.length===0&&!n.field)return s`<div class="stub">${t.i18n.t("panel.screen.not_in_this_version")}</div>`;let r=n.field;return s`
  ...
  `};var Ft=(n,t)=>{let e=n.field;return e?s`<div class="reading ${e.big===!1?"":"big"}">
  ...
  </div>`:s`<div class="stub">${t.i18n.t("panel.screen.not_in_this_version")}</div>`};var Wt=(n,t)=>{let e=n.summary;return e?s`
    <div class="summary">
...
`;var xr=/^\/myhome_static\/[A-Za-z0-9._~\-/]+$/,$r=/(^|\/)\.\.?(\/|$)/,Kt=/^[A-Za-z0-9 %.,\-]+$/,kr=n=>{if(!xr.test(n.src)||$r.test(n.src))return null;let t=n.size&&Kt.test(n.size)?n.size:"100% auto",e=n.pos&&Kt.test(n.pos)?n.pos:"50% 60%";return{backgroundImage:`url("${n.src}")`,backgroundSize:t,backgroundPosition:e}},oe=class extends w{constructor(){super();this._fire=(e,r)=>{this.dispatchEvent(new CustomEvent("myhome-screen-action",{detail:{action:e,value:r,screen:this.model?.id??""},bubbles:!0,composed:!0}))};this.model=null,this.i18n=new x}static{this.properties={model:{attribute:!1},i18n:{attribute:!1}}}static{this.styles=[A,M,I,J,Q,jt,u`
      :host {
        display: block;
        background: transparent;
      }
    ...
    `]}_renderOperative(e,r){switch(e.model){case"scelta":return Nt(e,r);case"pos":return Ut(e,r);case"click":return qt(e,r);case"controllo":return Bt(e,r);case"metro":return Ft(e,r);case"riepilogo":return Wt(e,r);case"esito":return Gt(e,r);case"lettura":return Dt(e,r);default:return l}}_renderFooter(e,r){let o=e.secondary??[];return!e.primary&&o.length===0?l:s`<div class="footer">
      ${e.primary?s`<button
    ...
    ></myhome-screen>`}get _locked(){let e=this._store.state;return e.overview?.measuring!=null||e.applying}async _confirm(){let e=this._store.state,r=e.entryId;if(this._locked||!r||e.pending.length===0)return;if(e.pending.filter(p=>{let d=e.overview?.covers.find(c=>c.unique_id===p.cover);return d!==void 0&&at(d,p)&&q(e.heights[p.cover])!==null}).length>0){this._store.set({heightsForced:!0}),this._store.announce(this._i18n.t("panel.assign.announce.missing_travel"));return}let i=xe(e.pending,e.heights),a=e.order??void 0;this._store.announce(this._i18n.t("panel.assign.announce.applying")),await this._write(()=>Je(this.hass.connection,r,i,a),p=>{this._store.set({...Se}),this._store.setOverview(p.overview),this._snack(p.applied===1?this._i18n.t("panel.toast.assigned_one"):this._i18n.t("panel.toast.assigned",{count:p.applied}),p.undo_token)})}async _undo(){let e=this._store.state,r=e.snack?.undoToken;if(!r||!e.entryId)return;let o=e.entryId;this._clearSnack(),await this._write(()=>et(this.hass.connection,o,r),i=>{this._store.setOverview(i.overview),this._snack(this._i18n.t("panel.toast.undone"),null)})}async _write(e,r,o){this._store.set({applying:!0,writeError:null});try{let i=await e();this._store.set({applying:!1}),r(i)}catch(i){let a=T(i);this._store.set({applying:!1,writeError:a});let p=this._i18n.refusal(a.translation_key,a.translation_placeholders??{});this._store.announce(p),o?.(p)}}_snack(e,r,o=!0){this._clearSnack(),this._store.set({snack:{message:e,undoToken:r}}),o&&this._store.announce(e),this._snackTimer=setTimeout(()=>{this._snackTimer=null,this._store.set({snack:null})},Sr)}_clearSnack(){this._snackTimer&&(clearTimeout(this._snackTimer),this._snackTimer=null),this._store.set({snack:null})}_schedulePreview(){this._store.state.review&&(this._previewTimer&&clearTimeout(this._previewTimer),this._previewTimer=setTimeout(()=>{this._previewTimer=null,this._refreshPreview()},Pr))}async _refreshPreview(){let e=this._store.state;if(!e.entryId||e.pending.length===0){this._store.set({preview:null});return}let r=++this._previewSeq;this._store.set({previewing:!0});try{let o=await Ye(this.hass.connection,e.entryId,xe(e.pending,e.heights));r===this._previewSeq&&this._store.set({preview:o.items,previewing:!1})}catch(o){r===this._previewSeq&&this._store.set({previewing:!1}),ye(o)||console.warn("MyHOME panel: the preview could not be read",T(o))}}_renderView(){let e=this._store.state;if(e.status==="loading")return s`<div class="card waiting" role="status">
        ...
        <div class="soft">
          ...
          <a href=${B}>${this._i18n.t("panel.common.action.configure")}</a>
