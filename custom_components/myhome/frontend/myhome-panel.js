...
`);if(s.every(Yi)){e.push(a`<ul>
  ...
  </div>`,li=(n,t,e)=>a`<div class="strip dark armed" role="status">
  ...
  </div>`,pi=n=>{let{i18n:t}=n;return a`<div class="strip pending-bar">
    <span class="count"
  ...
  >
    ...
    >
      ...
      <div class="options">
        ${n.profiles.map(i=>e(i.name,t.t("panel.dialog.option.profile",{profile:i.name}),an(t,i)))}
  ...
  >
    ...
    <div class="sheet" role="dialog" aria-modal="true" aria-labelledby="review-title" data-focus-root>
      ...
      <div class="body" aria-busy=${n.previewing?"true":"false"}>
        ...
        ${i.map(({change:p,cover:d})=>{let c=e.get(p.cover),m=n.heights[p.cover],h=p.to!==null&&d.height===null,v=h?ie(m):null,_=v!==null&&(n.forced||(m??"")!==""),H=c&&c.problem===null?o.filter(w=>c.values[w]!==void 0&&d.values[w]!==void 0):[];return a`<section class="item">
            <div class="line">
            ...
            ${(()=>{let w=ln(t,d,p,c,n.profiles);return w?a`<p class="note">${w}</p>`:l})()}
          </section>`})}
  ...
  `};var Le=class extends f{constructor(){super();this._trap=new $e;this._returnTo=null;this._returnToRow=null;this._onKey=e=>{if(e.key==="Escape"){if(this.state.drag){this._drag.cancel();return}if(this.state.armed){this.actions.arm(null);return}if(this.state.dialog){this.actions.dialog(null);return}this.state.review&&!this.state.applying&&this.actions.review(!1)}};this._flip=null;this._narrowQuery=typeof matchMedia=="function"?matchMedia("(max-width: 599px)"):null;this._onWidth=()=>this.requestUpdate();this._route=e=>{let i=ge(e.unique_id,this.state.pending);return i?this.i18n.t("panel.assign.pending.route",{from:this._groupName(e.profile??null),to:this._groupName(i.to)}):""};this._onGrab=(e,i)=>{this._drag.press(e.unique_id,i)};this._onRowPress=(e,i)=>{this._narrow&&!this._locked&&this._drag.arm(e.unique_id,i)};this.i18n=new y,this.state=U({view:"overview",params:{},path:"/"}),this.actions={},this._drag=new Ae({root:()=>this.renderRoot,blocked:()=>this._locked,narrow:()=>this._narrow,onArm:e=>{let i=this._cover(e);i&&this.actions.arm(i)},onStart:e=>{let i=this._cover(e);i&&(this._drag.ghost(i.name,this.renderRoot),this.actions.drag(i))},onOver:e=>this.actions.over(e),onEnd:e=>this._endDrag(e)})}static{this.properties={i18n:{attribute:!1},state:{attribute:!1},actions:{attribute:!1}}}static{this.styles=[E,P,S,D,Ie,hi,gi,Se,mi,bi,u`:host{display:block;background:transparent}.intro{margin:8px 0 4px;max-width:72ch}.intro p{margin:0 0 8px;line-height:1.55}.counts{margin:0 0 16px;color:var(--myhome-text-soft)}.controls{display:flex;gap:12px;align-items:center;flex-wrap:wrap;margin:0 0 16px}.controls .search{flex:1 1 220px;max-width:340px}.controls .spacer{flex:1 1 auto}.select-wrap{position:relative;display:inline-flex}.select-wrap:after{content:"";position:absolute;right:13px;top:50%;width:7px;height:7px;border-right:1.6px solid var(--myhome-text-soft);border-bottom:1.6px solid var(--myhome-text-soft);border-radius:1px;transform:translateY(-70%) rotate(45deg);pointer-events:none}select.field{appearance:none;padding-right:36px}a.cta{display:inline-flex;align-items:center;text-decoration:none}.welcome{max-width:640px;margin:48px auto;padding:32px}.welcome h2{margin:0 0 12px;font-size:22px;font-weight:500}.welcome p{margin:0 0 8px;line-height:1.55}.welcome .soft{color:var(--myhome-text-soft);margin-bottom:24px}.welcome .after{margin:12px 0 0;font-size:13px;color:var(--myhome-text-soft)}.notice{padding:16px;margin:16px 0;font-size:14px;line-height:1.55}.notice .actions{margin-top:12px}.groups{margin-bottom:96px}.groups.armed{margin-bottom:120px}.drag-ghost{position:fixed;left:0;top:0;z-index:80;pointer-events:none;background:var(--myhome-card);color:var(--myhome-text);border:1px solid var(--myhome-primary-ink);border-radius:8px;box-shadow:var(--myhome-shadow);padding:10px 14px;font-size:14px;max-width:260px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}`]}connectedCallback(){super.connectedCallback(),window.addEventListener("keydown",this._onKey),this._narrowQuery?.addEventListener("change",this._onWidth)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this._onKey),this._narrowQuery?.removeEventListener("change",this._onWidth),this._drag.stop(),this._trap.release()}updated(e){if(this._locked){let i=this._drag.dragging!==null;this._drag.stop(),i&&this.actions.announce(this.i18n.t("panel.assign.announce.drag_cancelled"))}if(e.has("state")){let i=e.get("state");if(this._manageFocus(i),this._flip){let r=this._flip;this._flip=null,requestAnimationFrame(()=>ci(this.renderRoot,r))}}}_beforeMove(){this._flip=di(this.renderRoot)}_manageFocus(e){let i=this.state.dialog!==null||this.state.review,r=(e?.dialog??null)!==null||(e?.review??!1);if(i&&!r){let o=this._activeElement();this._returnTo=o,this._returnToRow=o?.closest("[data-row]")?.getAttribute("data-row")??null,requestAnimationFrame(()=>{let s=this.renderRoot.querySelector("[data-focus-root]");s&&this._trap.hold(s)});return}if(!i&&r){this._trap.release();let o=this._returnTo,s=this._returnToRow;this._returnTo=null,this._returnToRow=null,requestAnimationFrame(()=>{((s?[...this.renderRoot.querySelectorAll("[data-row]")].find(c=>c.getAttribute("data-row")===s)?.querySelector(".handle"):null)??(o?.isConnected?o:null))?.focus()})}}_activeElement(){let e=this.renderRoot.activeElement;return e instanceof HTMLElement?e:null}get _overview(){return this.state.overview}get _locked(){return this._overview?.measuring!=null||this.state.applying}get _narrow(){return this._narrowQuery?.matches??!1}_cover(e){return this._overview?.covers.find(i=>i.unique_id===e)}get _covers(){let e=this._overview;return e?jt(e,this.state.order):[]}get _rooms(){let e=new Set;for(let i of this._overview?.covers??[])i.area&&e.add(i.area);return Array.from(e).sort((i,r)=>i.localeCompare(r,this.i18n.language))}_matches(e){let i=this.state.search.trim().toLowerCase();return i&&!e.name.toLowerCase().includes(i)?!1:!this.state.room||e.area===this.state.room}_groupName(e){return e===null?this.i18n.t("panel.overview.group.no_profile"):this.i18n.t("panel.overview.group.profile",{profile:e})}_valuesLine(e){return e.missing||!e.values||e.values.opening_time===void 0?this.i18n.t("panel.overview.group.values_unknown"):this.i18n.t("panel.overview.group.values",{travel:e.reference_height===null?"?":this.i18n.number(e.reference_height,0),opening:this.i18n.number(e.values.opening_time,1),closing:this.i18n.number(e.values.closing_time,1),slat:this.i18n.number(e.values.slat_time,1)})}_provenanceLine(e){if(e.source==="yaml")return this.i18n.t("panel.overview.group.from_file");if(!e.measured_on)return this.i18n.t("panel.overview.group.provenance_missing");let i=e.measured_at?this.i18n.date(e.measured_at):"";if(!e.measured_on_name)return this.i18n.t("panel.overview.group.measured_on_gone",{date:i});let r=this.i18n.t("panel.overview.group.measured_on",{cover:e.measured_on_name,date:i}),o=(this._overview?.covers??[]).find(s=>s.unique_id===e.measured_on);if(o&&o.profile!==e.name){let s=o.profile??this.i18n.t("panel.overview.group.no_profile");r+=` · ${this.i18n.t("panel.profile.provenance_now_profile",{profile:s})}`}return r}get _groups(){let e=this._overview;if(!e)return[];let i=this._covers,r=s=>i.filter(p=>ve(p,this.state.pending)===s&&this._matches(p)),o=e.profiles.map((s,p)=>({key:s.name,id:`group-${p}`,title:this.i18n.t("panel.overview.group.profile",{profile:s.name}),values:this._valuesLine(s),provenance:this._provenanceLine(s),warning:s.missing?this.i18n.t("panel.overview.group.missing"):"",covers:r(s.name)}));return o.push({key:null,id:"group-none",title:this.i18n.t("panel.overview.group.no_profile"),values:this.i18n.t("panel.overview.group.no_profile_note"),provenance:"",warning:"",covers:r(null)}),o}_appendAtEnd(e,i){if(this.state.order===null||i===(e.profile??null))return;let r=this._covers;this.actions.setOrder(Gt(r.map(o=>o.unique_id),e.unique_id,r.filter(o=>ve(o,this.state.pending)===i).map(o=>o.unique_id)))}_endDrag(e){let i=this.state,r=i.drag,o=r?.insert??null,s=r?.over??null,p=r?this._cover(r.cover):void 0;if(this.actions.drag(null),!e||!p||s===null){r&&this.actions.announce(this.i18n.t("panel.assign.announce.drag_cancelled"));return}let d=fi(s),c=this._covers.map(_=>_.unique_id),m=tt(c,p.unique_id,o??{beforeId:null,afterId:null});this._beforeMove();let h=ge(p.unique_id,i.pending),v=h?h.to:p.profile??null;if(d!==v){this.actions.setOrder(m),this.actions.assign(p,d);return}if(i.pending.length>0){this.actions.setOrder(m),this.actions.announce(this.i18n.t("panel.assign.announce.reordered"));return}this.actions.reorder(m)}_renderControls(){return a`<div class="controls">
      ...
      ${r===0&&o?a`<div class="card notice">
            ...
            ${i.map(p=>{let d=st(p.key),c=s?.insert??null,m=c!==null&&c.group===d;return _i(p,{i18n:this.i18n,pending:this.state.pending,route:this._route,locked:this._locked,collapsed:this.state.armed!==null,over:s?.over===d,insertBefore:m?c.beforeId:null,insertEnd:m?c.end||c.afterId===p.covers.at(-1)?.unique_id:!1,dragging:s?.cover??null,onOpenProfile:h=>this.actions.openProfile(h),onOpenCover:h=>this.actions.openCover(h.unique_id),onGrab:this._onGrab,onRowPress:this._onRowPress,onPick:h=>this.actions.dialog(h),onWithdraw:h=>{this._beforeMove(),this.actions.withdraw(h)},onTarget:h=>{let v=this.state.armed?this._cover(this.state.armed):void 0;v&&(this._beforeMove(),this._appendAtEnd(v,h),this.actions.assign(v,h))}})})}
          </div>`}
...
>
  ...
  ${e}
    ...
    </section>`}_view(e,i){let r=j.map(p=>i.find(d=>d.key===p)).filter(p=>p!==void 0),o=e.has_own.length>0,s=o&&e.level!=="precise";return a`<section class="card">
    ...
    </section>`}_field(e){let i=this.state.detail.form[e.key],r=b(e.key,i),o=e.inherited_value===null?this.i18n.t("panel.detail.edit.empty"):this.i18n.t("panel.detail.edit.inherits",{value:this._number(e.key,e.inherited_value)});return le({label:this._label(e.key),value:i??"",unit:this._unit(e.key),placeholder:o,error:r?this._problem(e.key,r):null,disabled:this.state.applying,onInput:s=>this.actions.field(e.key,s)})}_travel(e){let i=this.state.detail.form.height,r=b("height",i),o=this.state.detail.preview,s=o&&o.problem===null?j.filter(p=>o.values[p]!==void 0&&e.values[p]!==void 0):[];return a`<section class="card">
    ...
    ${i==="delete"?this._delete(e):l}`}_head(e){let r=(this.state.overview?.covers??[]).find(p=>p.unique_id===e.measured_on),o;e.measured_on&&e.measured_on_name&&e.measured_at?(o=this.i18n.t("panel.profile.provenance",{cover:e.measured_on_name,date:this.i18n.date(e.measured_at)}),r&&r.profile!==e.name&&(o+=` · ${r.profile?this.i18n.t("panel.profile.provenance_now_profile",{profile:r.profile}):this.i18n.t("panel.profile.provenance_now_none")}`)):e.measured_on&&e.measured_at?o=this.i18n.t("panel.overview.group.measured_on_gone",{date:this.i18n.date(e.measured_at)}):o=this.i18n.t("panel.profile.provenance_missing");let s=e.editable?this.i18n.t("panel.profile.stored"):this.i18n.t("panel.profile.from_file");return a`<section class="card">
      ...
      ${e.editable?a`<section class="card actions">
          ...
          </section>`:l}`}_follower(e){let r=L.every(o=>e.has_own.includes(o))?this.i18n.t("panel.profile.followers.measured"):e.has_own.length>0?this.i18n.t("panel.profile.followers.adjusted",{keys:this._ownKeys(e)}):this.i18n.t("panel.profile.followers.inherited");return a`<div class="row">
      <span class="what">
        <button
          class="cta text"
          type="button"
      ...
      <div class="fields">
        ${G.map(s=>le({label:this._label(s),value:i[s]??"",unit:this._unit(s),error:k(i[s])?this.i18n.t("panel.common.required"):(()=>{let p=b(s,i[s]);return p?this._problem(s,p):null})(),disabled:this.state.applying,onInput:p=>this.actions.field(s,p)}))}
      </div>
    ...
    </section>`}};customElements.get("myhome-profile-card")||customElements.define("myhome-profile-card",De);var $i=(n,t)=>n.summary?.note?a`<div class="stub">${n.summary.note}</div>`:l;var ki=(n,t)=>{let e=n.options??[];return e.length===0?l:a`<div class="options" role="group" aria-label=${n.title}>
    ${e.map(i=>a`<button
        class="option"
        type="button"
  ...
  </div>`};var Ri=(n,t)=>{let e=n.progress;if(!e)return a`<div class="stub">${t.i18n.t("panel.screen.not_in_this_version")}</div>`;let i=Math.max(0,Math.min(1,e.fraction))*100;return a`<div class="progress-card">
  ...
  </div>`};var Ei=(n,t)=>{let e=n.press;if(!e)return a`<div class="stub">${t.i18n.t("panel.screen.not_in_this_version")}</div>`;let i=e.state==="moving";return a`
  ...
  `};var Pi=(n,t)=>{let e=n.options??[];if(e.length===0&&!n.field)return a`<div class="stub">${t.i18n.t("panel.screen.not_in_this_version")}</div>`;let i=n.field;return a`
  ...
  `};var dn=n=>{let t=[n.hint?"reading-hint":"",n.error?"reading-error":""].filter(e=>e!=="");return t.length>0?t.join(" "):void 0},Si=(n,t)=>{let e=n.field;return e?a`<div class="reading ${e.big===!1?"":"big"}">
  ...
  </div>`:a`<div class="stub">${t.i18n.t("panel.screen.not_in_this_version")}</div>`};var Ti=(n,t)=>{let e=n.summary;return e?a`
    <div class="summary">
  ...
  `:a`<div class="stub">${t.i18n.t("panel.screen.not_in_this_version")}</div>`};var Ci=(n,t)=>n.summary?.rows?.length?a`<div class="summary">
    ...
    </div>`}render(){let e=this.model;if(!e)return l;let i={i18n:this.i18n,fire:this._fire},r=e.model==="pos",o=e.image?Tt(e.image):null;return a`<div class="screen">
