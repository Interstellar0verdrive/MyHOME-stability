...
`;var We=o=>s`<div class="sr-only" role="status" aria-live="polite" aria-atomic="true">${o}</div>`;var De=h`
  .measuring {
    max-width: 1200px;
    margin: 16px auto 0;
    padding: 12px 16px;
...
`,Be=(o,e,t)=>s`<div class="measuring" role="status" aria-live="polite">
...
`,qe=(o,e,t,r)=>{let n=e==="measured"?"measured":e==="adjusted"?"adjusted":"neutral",i;return r&&e==="inherited"?i=o.t("panel.overview.origin_short_inherited"):r&&e==="adjusted"?i=o.t("panel.overview.origin_short_adjusted"):i=o.origin(e,t),s`<span class="chip ${n}"
...
`,At=(o,e)=>{let t=e.height===null?o.t("panel.common.travel_unknown"):o.t("panel.common.travel",{travel:o.number(e.height,0)});return e.area?`${e.area} · ${t}`:t},Ve=(o,e)=>{let{i18n:t}=e;return s`<div class="row" data-row=${o.unique_id}>
    ...
    >
      ...
      <span class="chips">
        ${qe(t,o.origin,o.profile,e.short)}
      </span>
...
`,Ke=(o,e)=>{let{i18n:t}=e,r=o.covers.length===1?t.t("panel.overview.count_one"):t.t("panel.overview.count_other",{count:o.covers.length});return s`<section class="group" data-group=${o.key??"none"} aria-labelledby=${o.id}>
    ...
    <div class="group-body">
      ${o.covers.map((n,i)=>Ve(n,{i18n:t,short:n.profile===o.key,first:i===0,onOpen:e.onOpenCover}))}
      ${o.covers.length===0?s`<p class="empty">${t.t("panel.overview.group_empty")}</p>`:l}
    </div>
  </section>`};var U="/config/integrations/integration/myhome",Z=class extends g{static{this.properties={i18n:{attribute:!1},overview:{attribute:!1},search:{type:String},room:{type:String}}}constructor(){super(),this.i18n=new x,this.overview=null,this.search="",this.room=""}static{this.styles=[C,E,T,K,je,Fe,Ge,h`
      :host {
        display: block;
        background: transparent;
      }
    ...
    `]}_fire(e,t){this.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0}))}get _rooms(){let e=new Set;for(let t of this.overview?.covers??[])t.area&&e.add(t.area);return Array.from(e).sort((t,r)=>t.localeCompare(r,this.i18n.language))}_matches(e){let t=this.search.trim().toLowerCase();return t&&!e.name.toLowerCase().includes(t)?!1:!this.room||e.area===this.room}_valuesLine(e){return e.missing||!e.values||e.values.opening_time===void 0?this.i18n.t("panel.overview.group_values_unknown"):this.i18n.t("panel.overview.group_values",{travel:e.reference_height===null?"?":this.i18n.number(e.reference_height,0),up:this.i18n.number(e.values.opening_time,1),down:this.i18n.number(e.values.closing_time,1),slat:this.i18n.number(e.values.slat_time,1)})}_provenanceLine(e){if(e.source==="yaml")return this.i18n.t("panel.overview.group_from_file");if(!e.measured_on)return this.i18n.t("panel.overview.provenance_unknown");let t=e.measured_at?this.i18n.date(e.measured_at):"";if(!e.measured_on_name)return this.i18n.t("panel.overview.provenance_gone",{date:t});let r=this.i18n.t("panel.overview.provenance",{cover:e.measured_on_name,date:t}),n=(this.overview?.covers??[]).find(i=>i.unique_id===e.measured_on);if(n&&n.profile!==e.name){let i=n.profile??this.i18n.t("panel.overview.group_none");r+=` · ${this.i18n.t("panel.overview.provenance_follows",{profile:i})}`}return r}get _groups(){let e=this.overview;if(!e)return[];let t=[...e.covers].sort((i,a)=>i.order_index-a.order_index),r=i=>t.filter(a=>(a.profile??null)===i&&this._matches(a)),n=e.profiles.map((i,a)=>({key:i.name,id:`group-${a}`,title:this.i18n.t("panel.overview.group_profile",{profile:i.name}),values:this._valuesLine(i),provenance:this._provenanceLine(i),warning:i.missing?this.i18n.t("panel.overview.group_missing"):"",covers:r(i.name)}));return n.push({key:null,id:"group-none",title:this.i18n.t("panel.overview.group_none"),values:this.i18n.t("panel.overview.group_none_meta"),provenance:"",warning:"",covers:r(null)}),n}_renderControls(){return s`<div class="controls">
      ...
      <p class="after">${this.i18n.t("panel.overview.measure_hint")}</p>
        ...
        ${A(this.i18n.t("panel.overview.no_basic_covers"))}
    ...
    `}};customElements.get("myhome-overview")||customElements.define("myhome-overview",Z);var Xe={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Ze=o=>(...e)=>({_$litDirective$:o,values:e}),Y=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,r){this._$Ct=e,this._$AM=t,this._$Ci=r}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}};var Ye="important",Ct=" !"+Ye,Je=Ze(class extends Y{constructor(o){if(super(o),o.type!==Xe.ATTRIBUTE||o.name!=="style"||o.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(o){return Object.keys(o).reduce((e,t)=>{let r=o[t];return r==null?e:e+`${t=t.includes("-")?t:t.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${r};`},"")}update(o,[e]){let{style:t}=o.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(e)),this.render(e);for(let r of this.ft)e[r]==null&&(this.ft.delete(r),r.includes("-")?t.removeProperty(r):t[r]=null);for(let r in e){let n=e[r];if(n!=null){this.ft.add(r);let i=typeof n=="string"&&n.endsWith(Ct);r.includes("-")||i?t.setProperty(r,i?n.slice(0,-11):n,i?Ye:""):t[r]=n}}return y}});var Qe=(o,e)=>o.summary?.note?s`<div class="stub">${o.summary.note}</div>`:l;var et=(o,e)=>{let t=o.options??[];return t.length===0?l:s`<div class="options" role="group" aria-label=${o.title}>
    ${t.map(r=>s`<button
        class="option"
        type="button"
  ...
  </div>`};var tt=(o,e)=>{let t=o.progress;if(!t)return s`<div class="stub">${e.i18n.t("panel.screen.not_in_this_version")}</div>`;let r=Math.max(0,Math.min(1,t.fraction))*100;return s`<div class="progress-card">
  ...
  </div>`};var rt=(o,e)=>{let t=o.press;if(!t)return s`<div class="stub">${e.i18n.t("panel.screen.not_in_this_version")}</div>`;let r=t.state==="moving";return s`
  ...
  `};var ot=(o,e)=>{let t=o.options??[];if(t.length===0&&!o.field)return s`<div class="stub">${e.i18n.t("panel.screen.not_in_this_version")}</div>`;let r=o.field;return s`
  ...
  `};var nt=(o,e)=>{let t=o.field;return t?s`<div class="reading ${t.big===!1?"":"big"}">
  ...
  </div>`:s`<div class="stub">${e.i18n.t("panel.screen.not_in_this_version")}</div>`};var it=(o,e)=>{let t=o.summary;return t?s`
    <div class="summary">
  ...
  `:s`<div class="stub">${e.i18n.t("panel.screen.not_in_this_version")}</div>`};var st=(o,e)=>o.summary?.rows?.length?s`<div class="summary">
...
`;var Et=/^\/myhome_static\/[A-Za-z0-9._~\-/]+$/,Tt=/(^|\/)\.\.?(\/|$)/,lt=/^[A-Za-z0-9 %.,\-]+$/,Pt=o=>{if(!Et.test(o.src)||Tt.test(o.src))return null;let e=o.size&&lt.test(o.size)?o.size:"100% auto",t=o.pos&&lt.test(o.pos)?o.pos:"50% 60%";return{backgroundImage:`url("${o.src}")`,backgroundSize:e,backgroundPosition:t}},J=class extends g{constructor(){super();this._fire=(t,r)=>{this.dispatchEvent(new CustomEvent("myhome-screen-action",{detail:{action:t,value:r,screen:this.model?.id??""},bubbles:!0,composed:!0}))};this.model=null,this.i18n=new x}static{this.properties={model:{attribute:!1},i18n:{attribute:!1}}}static{this.styles=[C,E,T,K,X,at,h`
      :host {
        display: block;
        background: transparent;
      }
    ...
    `]}_renderOperative(t,r){switch(t.model){case"scelta":return et(t,r);case"pos":return tt(t,r);case"click":return rt(t,r);case"controllo":return ot(t,r);case"metro":return nt(t,r);case"riepilogo":return it(t,r);case"esito":return st(t,r);case"lettura":return Qe(t,r);default:return l}}_renderFooter(t,r){let n=t.secondary??[];return!t.primary&&n.length===0?l:s`<div class="footer">
      ${t.primary?s`<button
    ...
    </div>`}render(){let t=this.model;if(!t)return l;let r={i18n:this.i18n,fire:this._fire},n=t.model==="pos",i=t.image?Pt(t.image):null;return s`<div class="screen">
      <main class=${n?"single":""}>
        <div class="text-column">
          ...
          ${i?s`<div
                ...
                style=${Je(i)}
              ></div>`:l}
          ${t.body?s`<div class="prose">${A(t.body)}</div>`:l}
        </div>
        <div class="right">
          ${this._renderOperative(t,r)} ${this._renderFooter(t,r)}
        </div>
      </main>
    </div>`}};customElements.get("myhome-screen")||customElements.define("myhome-screen",J);var Mt=3e4,me=class extends g{constructor(){super();this._i18n=new x;this._router=new V;this._store=new G(this._router.current);this._unsubscribeStore=null;this._unsubscribeWs=null;this._poll=null;this._language="";this._started=!1;this._onReturn=()=>{!this._started||document.hidden||this._refresh()};this.narrow=!1,this.panel=null}static{this.properties={hass:{attribute:!1},narrow:{type:Boolean},route:{attribute:!1},panel:{attribute:!1}}}static{this.styles=[C,E,T,X,De,h`
      .toolbar {
        display: flex;
        align-items: center;
        gap: 8px;
