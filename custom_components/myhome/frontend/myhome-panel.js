...
`);if(a.every(Yi)){e.push(s`<ul>
  ...
  >
    ...
    >
      ...
      <div class="options">
        ${n.profiles.map(t=>e(t.name,i.t("panel.dialog.option.profile",{profile:t.name}),an(i,t)))}
    ...
    <div class="sheet" role="dialog" aria-modal="true" aria-labelledby="review-title" data-focus-root>
      ...
      <div class="body" aria-busy=${n.previewing?"true":"false"}>
        ...
        ${t.map(({change:p,cover:d})=>{let c=e.get(p.cover),m=n.heights[p.cover],h=p.to!==null&&d.height===null,v=h?ie(m):null,_=v!==null&&(n.forced||(m??"")!==""),H=c&&c.problem===null?o.filter(w=>c.values[w]!==void 0&&d.values[w]!==void 0):[];return s`<section class="item">
            ...
            ${(()=>{let w=ln(i,d,p,c,n.profiles);return w?s`<p class="note">${w}</p>`:l})()}
          </section>`})}
...
>
  ...
  ${e}
    ...
    </div>`}_rename(e){let t=this.state.profile.newName,r=t.trim()!==""&&!pn.test(t.trim()),o=r?this.i18n.refusal("invalid_name",{profile:t}):this.state.profile.nameError;return s`<section class="card">
    ...
    </section>`}};customElements.get("myhome-profile-card")||customElements.define("myhome-profile-card",De);var $i=(n,i)=>n.summary?.note?s`<div class="stub">${n.summary.note}</div>`:l;var ki=(n,i)=>{let e=n.options??[];return e.length===0?l:s`<div class="options" role="group" aria-label=${n.title}>
    ${e.map(t=>s`<button
        class="option"
        type="button"
  ...
  </div>`};var Ri=(n,i)=>{let e=n.progress;if(!e)return s`<div class="stub">${i.i18n.t("panel.screen.not_in_this_version")}</div>`;let t=Math.max(0,Math.min(1,e.fraction))*100;return s`<div class="progress-card">
  ...
  </div>`};var Ei=(n,i)=>{let e=n.press;if(!e)return s`<div class="stub">${i.i18n.t("panel.screen.not_in_this_version")}</div>`;let t=e.state==="moving";return s`
  ...
  `};var Pi=(n,i)=>{let e=n.options??[];if(e.length===0&&!n.field)return s`<div class="stub">${i.i18n.t("panel.screen.not_in_this_version")}</div>`;let t=n.field;return s`
  ...
  `};var dn=n=>{let i=[n.hint?"reading-hint":"",n.error?"reading-error":""].filter(e=>e!=="");return i.length>0?i.join(" "):void 0},Si=(n,i)=>{let e=n.field;return e?s`<div class="reading ${e.big===!1?"":"big"}">
  ...
  </div>`:s`<div class="stub">${i.i18n.t("panel.screen.not_in_this_version")}</div>`};var Ti=(n,i)=>{let e=n.summary;return e?s`
    <div class="summary">
  ...
  `:s`<div class="stub">${i.i18n.t("panel.screen.not_in_this_version")}</div>`};var Ci=(n,i)=>n.summary?.rows?.length?s`<div class="summary">
