...
\f\r]`,T=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,le=/-->/g,he=/>/g,$=RegExp(`>|${I}(?:([^\\s"'>=/]+)(${I}*=${I}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),ce=/'/g,de=/"/g,fe=/^(?:script|style|textarea|title)$/i,Q=i=>(e,...t)=>({_$litType$:i,strings:e,values:t}),f=Q(1),De=Q(2),We=Q(3),A=Symbol.for("lit-noChange"),h=Symbol.for("lit-nothing"),pe=new WeakMap,y=b.createTreeWalker(b,129);function ge(i,e){if(!G(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return ae!==void 0?ae.createHTML(e):e}var ke=(i,e)=>{let t=i.length-1,s=[],r,o=e===2?"<svg>":e===3?"<math>":"",n=T;for(let c=0;c<t;c++){let a=i[c],d,p,l=-1,u=0;for(;u<a.length&&(n.lastIndex=u,p=n.exec(a),p!==null);)u=n.lastIndex,n===T?p[1]==="!--"?n=le:p[1]!==void 0?n=he:p[2]!==void 0?(fe.test(p[2])&&(r=RegExp("</"+p[2],"g")),n=$):p[3]!==void 0&&(n=$):n===$?p[0]===">"?(n=r??T,l=-1):p[1]===void 0?l=-2:(l=n.lastIndex-p[2].length,d=p[1],n=p[3]===void 0?$:p[3]==='"'?de:ce):n===de||n===ce?n=$:n===le||n===he?n=T:(n=$,r=void 0);let g=n===$&&i[c+1].startsWith("/>")?" ":"";o+=n===T?a+Oe:l>=0?(s.push(d),a.slice(0,l)+ue+a.slice(l)+_+g):a+_+(l===-2?c:g)}return[ge(i,o+(i[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),s]},O=class i{constructor({strings:e,_$litType$:t},s){let r;this.parts=[];let o=0,n=0,c=e.length-1,a=this.parts,[d,p]=ke(e,t);if(this.el=i.createElement(d,s),y.currentNode=this.el.content,t===2||t===3){let l=this.el.content.firstChild;l.replaceWith(...l.childNodes)}for(;(r=y.nextNode())!==null&&a.length<c;){if(r.nodeType===1){if(r.hasAttributes())for(let l of r.getAttributeNames())if(l.endsWith(ue)){let u=p[n++],g=r.getAttribute(l).split(_),k=/([.?@])?(.*)/.exec(u);a.push({type:1,index:o,name:k[2],strings:g,ctor:k[1]==="."?q:k[1]==="?"?K:k[1]==="@"?F:w}),r.removeAttribute(l)}else l.startsWith(_)&&(a.push({type:6,index:o}),r.removeAttribute(l));if(fe.test(r.tagName)){let l=r.textContent.split(_),u=l.length-1;if(u>0){r.textContent=B?B.emptyScript:"";for(let g=0;g<u;g++)r.append(l[g],R()),y.nextNode(),a.push({type:2,index:++o});r.append(l[u],R())}}}else if(r.nodeType===8)if(r.data===me)a.push({type:2,index:o});else{let l=-1;for(;(l=r.data.indexOf(_,l+1))!==-1;)a.push({type:7,index:o}),l+=_.length-1}o++}}static createElement(e,t){let s=b.createElement("template");return s.innerHTML=e,s}};function x(i,e,t=i,s){if(e===A)return e;let r=s!==void 0?t._$Co?.[s]:t._$Cl,o=H(e)?void 0:e._$litDirective$;return r?.constructor!==o&&(r?._$AO?.(!1),o===void 0?r=void 0:(r=new o(i),r._$AT(i,t,s)),s!==void 0?(t._$Co??=[])[s]=r:t._$Cl=r),r!==void 0&&(e=x(i,r._$AS(i,e.values),r,s)),e}var V=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:s}=this._$AD,r=(e?.creationScope??b).importNode(t,!0);y.currentNode=r;let o=y.nextNode(),n=0,c=0,a=s[0];for(;a!==void 0;){if(n===a.index){let d;a.type===2?d=new U(o,o.nextSibling,this,e):a.type===1?d=new a.ctor(o,a.name,a.strings,this,e):a.type===6&&(d=new J(o,this,e)),this._$AV.push(d),a=s[++c]}n!==a?.index&&(o=y.nextNode(),n++)}return y.currentNode=b,r}p(e){let t=0;for(let s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(e,s,t),t+=s.strings.length-2):s._$AI(e[t])),t++}},U=class i{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,s,r){this.type=2,this._$AH=h,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=s,this.options=r,this._$Cv=r?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=x(this,e,t),H(e)?e===h||e==null||e===""?(this._$AH!==h&&this._$AR(),this._$AH=h):e!==this._$AH&&e!==A&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):Ue(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==h&&H(this._$AH)?this._$AA.nextSibling.data=e:this.T(b.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:s}=e,r=typeof s=="number"?this._$AC(e):(s.el===void 0&&(s.el=O.createElement(ge(s.h,s.h[0]),this.options)),s);if(this._$AH?._$AD===r)this._$AH.p(t);else{let o=new V(r,this),n=o.u(this.options);o.p(t),this.T(n),this._$AH=o}}_$AC(e){let t=pe.get(e.strings);return t===void 0&&pe.set(e.strings,t=new O(e)),t}k(e){G(this._$AH)||(this._$AH=[],this._$AR());let t=this._$AH,s,r=0;for(let o of e)r===t.length?t.push(s=new i(this.O(R()),this.O(R()),this,this.options)):s=t[r],s._$AI(o),r++;r<t.length&&(this._$AR(s&&s._$AB.nextSibling,r),t.length=r)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){let s=ne(e).nextSibling;ne(e).remove(),e=s}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},w=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,s,r,o){this.type=1,this._$AH=h,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=o,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=h}_$AI(e,t=this,s,r){let o=this.strings,n=!1;if(o===void 0)e=x(this,e,t,0),n=!H(e)||e!==this._$AH&&e!==A,n&&(this._$AH=e);else{let c=e,a,d;for(e=o[0],a=0;a<o.length-1;a++)d=x(this,c[s+a],t,a),d===A&&(d=this._$AH[a]),n||=!H(d)||d!==this._$AH[a],d===h?e=h:e!==h&&(e+=(d??"")+o[a+1]),this._$AH[a]=d}n&&!r&&this.j(e)}j(e){e===h?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},q=class extends w{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===h?void 0:e}},K=class extends w{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==h)}},F=class extends w{constructor(e,t,s,r,o){super(e,t,s,r,o),this.type=5}_$AI(e,t=this){if((e=x(this,e,t,0)??h)===A)return;let s=this._$AH,r=e===h&&s!==h||e.capture!==s.capture||e.once!==s.once||e.passive!==s.passive,o=e!==h&&(s===h||r);r&&this.element.removeEventListener(this.name,this,s),o&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},J=class{constructor(e,t,s){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(e){x(this,e)}};var Me=Z.litHtmlPolyfillSupport;Me?.(O,U),(Z.litHtmlVersions??=[]).push("3.3.3");var _e=(i,e,t)=>{let s=t?.renderBefore??e,r=s._$litPart$;if(r===void 0){let o=t?.renderBefore??null;s._$litPart$=r=new U(e.insertBefore(R(),o),o,void 0,t??{})}return r._$AI(i),r};var X=globalThis,v=class extends m{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=_e(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return A}};v._$litElement$=!0,v.finalized=!0,X.litElementHydrateSupport?.({LitElement:v});var Ne=X.litElementPolyfillSupport;Ne?.({LitElement:v});(X.litElementVersions??=[]).push("4.2.2");var ve=i=>i&&typeof i=="object"&&"code"in i?i:{code:"unknown_error",message:String(i)},$e=(i,e)=>i.sendMessagePromise({type:"myhome/calibration/overview",...e?{entry_id:e}:{}}),ye=(i,e)=>i.sendMessagePromise({type:"myhome/calibration/texts",language:e});var j=class{constructor(){this._texts={};this.language="en"}async load(e,t){let s=await ye(e,t);this._texts=s.texts??{},this.language=s.language}t(e,t){let s=this._texts;for(let r of e.split(".")){if(s===null||typeof s!="object")return t??e;s=s[r]}return typeof s=="string"?s:t??e}};var be=i=>typeof customElements<"u"&&customElements.get(i)!==void 0;var Ae=i=>{i.dispatchEvent(new CustomEvent("hass-toggle-menu",{bubbles:!0,composed:!0}))};var xe=C`
  :host {
...
`;var E={title:"Profiles and shutters",menu:"Open the sidebar",loading:"Loading…",summary:"{profiles} profiles, {covers} shutters",problem:"The panel could not read this gateway.",configure:"Open Configure instead"},Y=class extends v{constructor(){super();this._i18n=new j;this._overview=null;this._error=null;this._ready=!1;this._language="";this.narrow=!1,this.panel=null}static{this.properties={hass:{attribute:!1},narrow:{type:Boolean},route:{attribute:!1},panel:{attribute:!1},_overview:{state:!0},_error:{state:!0},_ready:{state:!0}}}static{this.styles=[xe,C`
      .toolbar {
        display: flex;
        align-items: center;
        gap: 8px;
    ...
    >
      ☰
    </button>`:h}_renderBody(){if(!this._ready)return f`<div class="card">${this._i18n.t("panel.common.loading",E.loading)}</div>`;if(this._error||!this._overview){let s=this._error;return f`<div class="card problem">
        ...
        <div class="soft">
          ...
          >
          ${this._version?f` · ${this._version}`:h}
        </div>
