      ...
      ></myhome-wizard>`}catch(e){return console.error("MyHOME panel: the guided calibration could not be drawn",e),a`<div class="card problem" role="alert">
        ...
        <div class="soft">
          ...
          <a href=${W}>${this._i18n.t("panel.common.action.configure")}</a>
            ...
            ></myhome-profile-card>`;return $n({i18n:this._i18n,title:this._drawerTitle(),hasBack:this._drawerBack!==null,applying:e.applying,onClose:this._closeDrawer,content:t})}render(){let e=this._store.state,t=this._title(),r=e.route.view!=="overview";return a`
      <!--
