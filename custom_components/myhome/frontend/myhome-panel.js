...
`);if(s.every(Cr)){e.push(a`<ul>
        ...
        ${s.map((l,c)=>c===0?Ie(l):[a`<br />`,...Ie(l)])}
      </p>`)}return a`${e}`};var b=n=>n&&typeof n=="object"&&"code"in n?n:{code:"unknown_error",message:String(n)},bi=(n,i)=>n.sendMessagePromise({type:"myhome/calibration/overview",...i?{entry_id:i}:{}}),xi=(n,i)=>n.sendMessagePromise({type:"myhome/calibration/texts",language:i}),$i=(n,i,e)=>n.sendMessagePromise({type:"myhome/calibration/cover_detail",entry_id:i,cover_unique_id:e}),Me=(n,i,e,t)=>n.sendMessagePromise({type:"myhome/calibration/preview",entry_id:i,items:e,...t?{profile_values:t}:{}}),ki=(n,i,e)=>n.subscribeMessage(e,{type:"myhome/calibration/subscribe",...i?{entry_id:i}:{}}),me=n=>b(n).code==="unknown_command",Si=(n,i,e,t)=>n.sendMessagePromise({type:"myhome/calibration/assign",entry_id:i,assignments:e,...t?{order:t}:{}}),Ri=(n,i,e,t)=>n.sendMessagePromise({type:"myhome/calibration/reorder",entry_id:i,order:e,...t!==void 0?{profile:t}:{}}),Ei=(n,i,e,t)=>n.sendMessagePromise({type:"myhome/calibration/set_travel",entry_id:i,cover_unique_id:e,height:t}),Ti=(n,i,e,t,r)=>n.sendMessagePromise({type:"myhome/calibration/cover_edit",entry_id:i,cover_unique_id:e,overrides:t,...r!==void 0?{height:r}:{}}),Ci=(n,i,e)=>n.sendMessagePromise({type:"myhome/calibration/cover_forget",entry_id:i,cover_unique_id:e}),Ai=(n,i,e,t,r)=>n.sendMessagePromise({type:"myhome/calibration/profile_edit",entry_id:i,name:e,values:t,reference_height:r}),Pi=(n,i,e,t)=>n.sendMessagePromise({type:"myhome/calibration/profile_rename",entry_id:i,name:e,new_name:t}),zi=(n,i,e)=>n.sendMessagePromise({type:"myhome/calibration/profile_delete",entry_id:i,name:e}),Ii=(n,i,e)=>n.sendMessagePromise({type:"myhome/calibration/undo",entry_id:i,undo_token:e}),Mi=(n,i)=>n.sendMessagePromise({type:"myhome/calibration/session/get",entry_id:i}),Oi=(n,i,e)=>n.sendMessagePromise({type:"myhome/calibration/session/start",entry_id:i,cover_unique_id:e.cover_unique_id,client_id:e.client_id,...e.path?{path:e.path}:{},...e.profile?{profile:e.profile}:{},...e.scope?{scope:e.scope}:{}}),Li=(n,i,e)=>n.sendMessagePromise({type:"myhome/calibration/session/attach",entry_id:i,session_id:e.session_id,client_id:e.client_id,...e.claim?{claim:!0}:{}}),Di=(n,i,e)=>n.sendMessagePromise({type:"myhome/calibration/session/heartbeat",entry_id:i,session_id:e.session_id,client_id:e.client_id}),Hi=(n,i,e)=>n.sendMessagePromise({type:"myhome/calibration/session/act",entry_id:i,session_id:e.session_id,client_id:e.client_id,revision:e.revision,action:e.action,...e.value===void 0?{}:{value:e.value}}),Fi=(n,i,e)=>n.sendMessagePromise({type:"myhome/calibration/session/stop",entry_id:i,session_id:e.session_id,client_id:e.client_id}),Ni=(n,i,e)=>n.sendMessagePromise({type:"myhome/calibration/session/leave",entry_id:i,session_id:e.session_id,client_id:e.client_id}),qi=(n,i,e)=>n.sendMessagePromise({type:"myhome/calibration/session/cancel",entry_id:i,client_id:e.client_id,...e.session_id?{session_id:e.session_id}:{},...e.force?{force:!0}:{}}),Wi=(n,i,e)=>n.sendMessagePromise({type:"myhome/calibration/session/save",entry_id:i,session_id:e.session_id,client_id:e.client_id,revision:e.revision,target:e.target}),Bi=(n,i)=>n.sendMessagePromise({type:"myhome/calibration/session/end_other",entry_id:i});var Ar=/\{([A-Za-z0-9_]+)\}/g,Oe=(n,i)=>i?n.replace(Ar,(e,t)=>Object.prototype.hasOwnProperty.call(i,t)?String(i[t]):e):n,Pr=/[“”„"‹›«»][\s  ]*(\{[A-Za-z0-9_]+\})[\s  ]*[“”„"‹›«»]/gu,Ui=n=>n.replace(Pr,"«$1»"),y=class{constructor(){this._texts={};this._numbers=new Map;this._dates=null;this._times=null;this.language="en";this.loaded=!1}async load(i,e){let t=await xi(i,e);this._texts=t.texts??{},this.language=t.language,this.loaded=!0,this._numbers.clear(),this._dates=null,this._times=null}t(i,e){let t=this._lookup(i);if(t!==null)return Oe(t,e);let r=$t[i];return Oe(r??i,e)}md(i,e){return J(this.t(i,e))}refusal(i,e){let t=i?this._lookup(`exceptions.${i}.message`):null;return t!==null?Oe(Ui(t),e):this.t("panel.error.not_found")}origin(i,e){let t=`selector.calibration_origin.options.${i}`;return Oe(Ui(this._lookup(t)??t),{profile:e??""})}number(i,e){let t=this._numbers.get(e);return t||(t=new Intl.NumberFormat(this.language,{minimumFractionDigits:e,maximumFractionDigits:e}),this._numbers.set(e,t)),t.format(i)}date(i){let e=new Date(i);return Number.isNaN(e.getTime())?i:(this._dates||(this._dates=new Intl.DateTimeFormat(this.language,{dateStyle:"long"})),this._dates.format(e))}time(i){let e=new Date(i);return Number.isNaN(e.getTime())?i:(this._times||(this._times=new Intl.DateTimeFormat(this.language,{timeStyle:"short"})),this._times.format(e))}_lookup(i){let e=this._texts;for(let t of i.split(".")){if(e===null||typeof e!="object")return null;e=e[t]}return typeof e=="string"?e:null}};var Ki=n=>typeof customElements<"u"&&customElements.get(n)!==void 0;var Gi=n=>{n.dispatchEvent(new CustomEvent("hass-toggle-menu",{bubbles:!0,composed:!0}))};var Le=(n,i)=>{let e=De(n.unique_id,i);return e?e.to:n.profile??null},De=(n,i)=>i.find(e=>e.cover===n),ji=(n,i)=>i===null?n.t("panel.assign.target_none"):n.t("panel.assign.pending.route_name",{profile:i}),Vi=(n,i,e)=>n.t("panel.assign.pending.route",{from:ji(n,i),to:ji(n,e)}),Yi=(n,i,e)=>{let t=n.filter(r=>r.cover!==i.unique_id);return e===(i.profile??null)?{pending:t,withdrawn:!0}:{pending:[...t,{cover:i.unique_id,to:e}],withdrawn:!1}},Xi=(n,i)=>{let e=new Map(n.covers.map(o=>[o.unique_id,o]));if(!i)return[...n.covers].sort((o,s)=>o.order_index-s.order_index);let t=new Set,r=[];for(let o of i){let s=e.get(o);s&&!t.has(o)&&(t.add(o),r.push(s))}for(let o of n.covers)t.has(o.unique_id)||r.push(o);return r},St=(n,i,e)=>{let t=n.filter(o=>o!==i),r=t.length;if(e.beforeId){let o=t.indexOf(e.beforeId);r=o<0?t.length:o}else if(e.afterId){let o=t.indexOf(e.afterId);r=o<0?t.length:o+1}return[...t.slice(0,r),i,...t.slice(r)]},Zi=(n,i,e)=>{let t=e.filter(r=>r!==i).at(-1)??null;return St(n,i,{beforeId:null,afterId:t})},Rt=(n,i,e)=>{let t=new Set(e.map(r=>r.unique_id));return n.filter(r=>t.has(r.cover)).map(r=>{let o=i[r.cover],s=o===void 0?void 0:M(o);return{cover_unique_id:r.cover,profile:r.to,...s==null?{}:{height:s}}})},M=n=>{let i=n.trim().replace(",",".");if(!i)return null;let e=Number(i);return Number.isFinite(e)?e:null},zr=20,Ir=500,ve=n=>{if(n===void 0||n.trim()==="")return"missing_travel";let i=M(n);return i===null?"not_a_number":i<zr||i>Ir?"out_of_range":null},Et=n=>({cover_unique_id:n.unique_id,profile:n.profile_from_file?null:n.profile??null}),Qi=(n,i)=>i.to!==null&&n.height===null,O=["opening_time","closing_time","slat_time","opening_roll","closing_roll"],fe=["opening_time","closing_time","slat_time"],ge=["opening_roll","closing_roll"],He=["slat_time",...ge],L={opening_time:1,closing_time:1,slat_time:1,opening_roll:2,closing_roll:2};var D={opening_time:{min:1,max:600,decimals:1},closing_time:{min:1,max:600,decimals:1},slat_time:{min:0,max:60,decimals:1},opening_roll:{min:1,max:5,decimals:2},closing_roll:{min:1,max:5,decimals:2},height:{min:20,max:500,decimals:0},reference_height:{min:20,max:500,decimals:0}},ee={opening_time:"panel.common.unit.seconds",closing_time:"panel.common.unit.seconds",slat_time:"panel.common.unit.seconds",opening_roll:null,closing_roll:null,height:"panel.common.unit.centimetres",reference_height:"panel.common.unit.centimetres"},N=n=>n.replace(/\s*\([^()]*\)\s*$/u,""),j=(n,i)=>i?`${n} ${i}`:n,x=(n,i)=>{let e=(i??"").trim();if(e==="")return null;let t=M(e);if(t===null)return"not_a_number";let r=D[n];return r&&(t<r.min||t>r.max)?"out_of_range":null},A=n=>(n??"").trim()==="";var q="/config/integrations/integration/myhome";var Tt="dialog-data-entry-flow",Mr=()=>typeof customElements<"u"&&customElements.get(Tt)!==void 0,Ji=n=>{history.pushState(null,"",n),window.dispatchEvent(new CustomEvent("location-changed",{detail:{replace:!1}}))},en=n=>Mr()?(n.source.dispatchEvent(new CustomEvent("show-dialog",{bubbles:!0,composed:!0,detail:{dialogTag:Tt,dialogImport:()=>Promise.resolve(),dialogParams:{startFlowHandler:n.entryId,domain:"myhome"}}})),setTimeout(()=>{document.querySelector(Tt)||(n.onLeaving(),Ji(q))},400),"waiting"):(n.onLeaving(),Ji(q),"page");var V=n=>n.view==="cover"||n.view==="profile",tn=(n,i,e)=>!V(e)||!V(i)?null:i.path===e.path?n:n&&n.path===e.path?null:i,nn=n=>n?.path??"/";var Or={view:"overview",params:{},path:"/"},rn=n=>{let i="/"+(n||"").replace(/^#/,"").replace(/^\/+/,"").replace(/\/+$/,"");if(i==="/")return Or;let e=i.slice(1).split("/"),t=e.slice(1).join("/"),r=t;try{r=decodeURIComponent(t)}catch{}return e[0]==="cover"&&t?{view:"cover",params:{id:r},path:i}:e[0]==="profile"&&t?{view:"profile",params:{name:r},path:i}:e[0]==="calibrate"?{view:"calibrate",params:{},path:"/calibrate"}:{view:"unknown",params:{},path:i}},on=(n,i)=>n==="calibrate"?"/calibrate":!i||n!=="cover"&&n!=="profile"?"/":`/${n}/${encodeURIComponent(i)}`,Fe=class{constructor(){this._onChange=()=>{};this._fromHost="/";this._listener=()=>this._emit()}start(i){this._onChange=i,window.addEventListener("hashchange",this._listener)}stop(){window.removeEventListener("hashchange",this._listener),this._onChange=()=>{}}setHostPath(i){let e=i||"/";if(e===this._fromHost)return;let t=this.current.path;this._fromHost=e,this.current.path!==t&&this._emit()}get current(){let i=typeof location<"u"?location.hash:"";return i&&i.length>1?rn(i.slice(1)):rn(this._fromHost)}navigate(i){let e="#"+(i.startsWith("/")?i:"/"+i);location.hash!==e&&(location.hash=e)}_emit(){this._onChange(this.current)}};var Lr=15e3,sn="myhome-calibration-client",an=/^[A-Za-z0-9-]{8,64}$/,_e=n=>n!==null&&(n.state==="saved"||n.state==="ended"),Ct=n=>n.translation_key??n.code,At=new Set(["unknown_session","session_ended"]),Dr=new Set(["unknown_entry","entry_not_loaded"]),Hr=()=>{try{let i=globalThis.crypto?.randomUUID?.();if(i&&an.test(i))return i}catch{}return`c-${`${Math.random().toString(36).slice(2)}${Date.now().toString(36)}`}`.replace(/[^A-Za-z0-9-]/g,"").slice(0,64).padEnd(8,"0")},Fr=()=>{try{return globalThis.sessionStorage??null}catch{return null}},Nr=n=>{try{let e=n?.getItem(sn);if(e&&an.test(e))return e}catch{}let i=Hr();try{n?.setItem(sn,i)}catch{}return i},Ne=class{constructor(i){this._session=null;this._capabilities=null;this._owner=!1;this._attachedTo=null;this._timer=null;this._disposed=!1;this._warned=!1;this._connection=i.connection,this.entryId=i.entryId,this._onChange=i.onChange??(()=>{}),this.clientId=i.clientId??Nr(i.storage===void 0?Fr():i.storage)}get session(){return this._session}get capabilities(){return this._capabilities}get owner(){return this._owner}get beating(){return this._timer!==null}async get(){try{let i=await Mi(this._connection,this.entryId);return this._capabilities=i.capabilities??this._capabilities,this._adopt(i.session),this._done(i.session)}catch(i){return this._failed(i)}}async start(i){try{let e=await Oi(this._connection,this.entryId,{cover_unique_id:i.cover,client_id:this.clientId,path:i.path,profile:i.profile,scope:i.scope});return this._attachedTo=e.session?.session_id??null,this._adopt(e.session),this._done(e.session)}catch(e){return this._failed(e)}}async attach(i,e=!1){try{let t=await Li(this._connection,this.entryId,{session_id:i,client_id:this.clientId,claim:e});return this._attachedTo=t.session?.session_id??null,this._adopt(t.session),this._done(t.session)}catch(t){return this._failed(t)}}async act(i,e){let t=this._session;if(!t)return this._failed({code:"not_found",message:"no session",translation_key:"unknown_session"});try{let r=await Hi(this._connection,this.entryId,{session_id:t.session_id,client_id:this.clientId,revision:t.revision,action:i,value:e});return this._adopt(r.session),this._done(r.session)}catch(r){return this._failed(r)}}async stop(){let i=this._session;if(!i)return this._failed({code:"not_found",message:"no session",translation_key:"unknown_session"});try{let e=await Fi(this._connection,this.entryId,{session_id:i.session_id,client_id:this.clientId});return this._adopt(e.session),this._done(e.session)}catch(e){return this._failed(e)}}async save(i){let e=this._session;if(!e)return this._failed({code:"not_found",message:"no session",translation_key:"unknown_session"});try{let t=await Wi(this._connection,this.entryId,{session_id:e.session_id,client_id:this.clientId,revision:e.revision,target:i});return this._adopt(t.session),{ok:!0,session:t.session,overview:t.overview??null}}catch(t){return this._failed(t)}}async leave(){let i=this._session;if(this._stopHeartbeat(),this._attachedTo=null,!i)return this._done(null);try{let e=await Ni(this._connection,this.entryId,{session_id:i.session_id,client_id:this.clientId});return this._adopt(e.session),this._done(e.session)}catch(e){return this._failed(e)}}async endOther(){try{let i=await Bi(this._connection,this.entryId);return{ok:!0,flowsAborted:i.flows_aborted,stillCalibrating:i.still_calibrating,overview:i.overview??null}}catch(i){return this._failed(i)}}async cancel({force:i=!1}={}){let e=this._session;try{let t=await qi(this._connection,this.entryId,{client_id:this.clientId,session_id:e?.session_id,force:i});return this._stopHeartbeat(),this._attachedTo=null,this._adopt(t.session),{ok:!0,branch:t.already_ended?"already_ended":"cancelled",session:t.session,error:null,recovery:[],freedAt:null}}catch(t){let r=b(t),o=Ct(r);if(o==="session_owned")return{ok:!1,branch:"owned",session:this._session,error:r,recovery:["claim_cancel","force"],freedAt:this._session?.idle_expires_at??null};if(At.has(o))return this._stopHeartbeat(),this._attachedTo=null,{ok:!0,branch:"gone",session:this._session,error:r,recovery:[],freedAt:null};let s=this._session?.idle_expires_at??null;return{ok:!1,branch:"unconfirmed",session:this._session,error:r,recovery:i&&s?["wait"]:["retry","force"],freedAt:s}}}async takeControl(){let i=this._session;return i?this.attach(i.session_id,!0):this._failed({code:"not_found",message:"no session",translation_key:"unknown_session"})}async claimAndCancel(){let i=this._session;if(!i)return this.cancel({force:!0});let e=await this.attach(i.session_id,!0);return e.ok?this.cancel():{ok:!1,branch:"unconfirmed",session:this._session,error:e.error,recovery:["force"],freedAt:this._session?.idle_expires_at??null}}apply(i){this._adopt(i)}async resume(){return this._attachedTo&&this._beat(),this.get()}dispose(){this._disposed=!0,this._stopHeartbeat(),this._attachedTo=null,this._onChange=()=>{}}_startHeartbeat(){this._timer!==null||this._disposed||!this._session||_e(this._session)||(this._timer=setInterval(()=>{this._beat()},Lr))}_stopHeartbeat(){this._timer!==null&&(clearInterval(this._timer),this._timer=null)}async _beat(){let i=this._session;if(!i||_e(i)){this._stopHeartbeat();return}try{let t=(await Di(this._connection,this.entryId,{session_id:i.session_id,client_id:this.clientId})).owner===!0;t!==this._owner&&(this._owner=t,this._notify())}catch(e){let t=Ct(b(e));if(At.has(t)){this._stopHeartbeat(),this._attachedTo=null;return}}}_adopt(i){this._session=i,this._owner=i?.owner?.client_id===this.clientId,i===null||_e(i)||i.session_id!==this._attachedTo?(this._stopHeartbeat(),i?.session_id!==this._attachedTo&&(this._attachedTo=null)):this._startHeartbeat(),this._notify()}_notify(){try{this._onChange(this._session)}catch(i){this._warned||(this._warned=!0,console.error("MyHOME panel: the calibration screen threw while it was being told",i))}}_done(i){return{ok:!0,session:i,overview:null}}_failed(i){let e=b(i),t=Ct(e),r=["retry"];return t==="session_owned"?r=["claim"]:t==="revision_conflict"||At.has(t)||t==="already_calibrating"?r=["reload"]:Dr.has(t)&&(r=["retry"]),{ok:!1,error:e,recovery:r,freedAt:this._session?.idle_expires_at??null}}};var Pt=["route","prepare","ascent","descent","readings","summary"],ln={route:"panel.wizard.phase.route",prepare:"panel.wizard.phase.prepare",ascent:"panel.wizard.phase.ascent",descent:"panel.wizard.phase.descent",readings:"panel.wizard.phase.readings",summary:"panel.wizard.phase.summary"},zt={path:{template:"scelta",phase:"route"},path_a:{template:"lettura",phase:"prepare"},path_b:{template:"scelta",phase:"route"},path_c:{template:"scelta",phase:"route"},refine_scope:{template:"scelta",phase:"route"},home_closed:{template:"pos",phase:"prepare",stoppable:!0},home_closed_done:{template:"controllo",phase:"prepare"},open_timed:{template:"pos",phase:"ascent",stoppable:!0},open_brief:{template:"lettura",phase:"ascent",cue:!0},open_start:{template:"click",phase:"ascent",display:"open_lift",press:"starting",stoppable:!0},open_lift:{template:"click",phase:"ascent",press:"moving",stoppable:!0},lift_stop:{template:"click",phase:"ascent",display:"open_lift",press:"registered"},lift_check:{template:"controllo",phase:"ascent"},lift_check_late:{template:"controllo",phase:"ascent",display:"lift_check"},lift_gap:{template:"controllo",phase:"ascent"},lift_early:{template:"controllo",phase:"ascent"},open_home_again:{template:"pos",phase:"ascent",stoppable:!0},closed_again:{template:"controllo",phase:"ascent"},open_full_brief:{template:"lettura",phase:"ascent",cue:!0},open_full_start:{template:"click",phase:"ascent",display:"open_top",press:"starting",stoppable:!0},open_top:{template:"click",phase:"ascent",press:"moving",stoppable:!0},open_result:{template:"lettura",phase:"ascent"},open_result_gap:{template:"lettura",phase:"ascent"},height_read:{template:"pos",phase:"readings",stoppable:!0},height:{template:"metro",phase:"readings"},height_result:{template:"lettura",phase:"readings"},close_timed:{template:"pos",phase:"descent",stoppable:!0},close_brief:{template:"lettura",phase:"descent",cue:!0},close_start:{template:"click",phase:"descent",display:"close_bottom",press:"starting",stoppable:!0},close_bottom:{template:"click",phase:"descent",press:"moving",stoppable:!0},close_result:{template:"lettura",phase:"descent"},tape_brief:{template:"lettura",phase:"readings"},half_down:{template:"pos",phase:"readings",stoppable:!0},half_up:{template:"pos",phase:"readings",stoppable:!0},quarter_down:{template:"pos",phase:"readings",stoppable:!0},three_quarter_down:{template:"pos",phase:"readings",stoppable:!0},quarter_up:{template:"pos",phase:"readings",stoppable:!0},three_quarter_up:{template:"pos",phase:"readings",stoppable:!0},verify:{template:"pos",phase:"readings",stoppable:!0},verify_b:{template:"pos",phase:"readings",stoppable:!0},tape_run:{template:"pos",phase:"readings",stoppable:!0},measure_descent:{template:"metro",phase:"readings"},measure_ascent:{template:"metro",phase:"readings"},tape_result:{template:"lettura",phase:"readings"},measure_verify:{template:"metro",phase:"readings"},verify_result:{template:"controllo",phase:"readings"},verify_offer:{template:"controllo",phase:"readings"},profile_name:{template:"metro",phase:"summary"},summary_basic:{template:"riepilogo",phase:"summary",own:!0},summary_short:{template:"riepilogo",phase:"summary",own:!0},summary_correction:{template:"riepilogo",phase:"summary",own:!0},summary_precise:{template:"riepilogo",phase:"summary",own:!0},problem_no_echo:{template:"esito",phase:null},problem_not_delivered:{template:"esito",phase:null},problem_not_stopped:{template:"esito",phase:null},problem_busy:{template:"esito",phase:null},problem_bad_point:{template:"esito",phase:null},problem_timeout:{template:"esito",phase:null},problem_unknown:{template:"esito",phase:null},problem_interrupted:{template:"esito",phase:null,own:!0}};var qr={run:1,slat:1,gap:1,height:1,measured:1,accuracy:1,deviation:1,expected:0,tolerance:0,percent:0,readings:0},Wr={travel_cm:0,opening_time_s:1,closing_time_s:1,slat_time_s:1,opening_roll:2,closing_roll:2,stop_latency_s:2,start_delay_s:2},Br={travel_cm:"cm",opening_time_s:"s",closing_time_s:"s",slat_time_s:"s",opening_roll:"",closing_roll:"",stop_latency_s:"s",start_delay_s:"s"},Ur={travel_cm:"height",opening_time_s:"opening_time",closing_time_s:"closing_time",slat_time_s:"slat_time",opening_roll:"opening_roll",closing_roll:"closing_roll"},It=(n,i)=>{let e=Ur[n];return e?i.t(`options.step.calibration_edit.data.${e}`):n==="stop_latency_s"?i.t("panel.wizard.review.key.stop_latency"):i.t("panel.wizard.review.key.start_delay")},we=(n,i,e)=>{if(i===null)return"—";let t=e.number(i,Wr[n]??1),r=Br[n]??"";if(r==="")return t;let o=r==="cm"?e.t("panel.common.unit.centimetres"):e.t("panel.common.unit.seconds");return`${t} ${o}`},dn=(n,i,e)=>{let t={};for(let[r,o]of Object.entries({...n,...e??{}}))o==null?t[r]="":typeof o=="number"?t[r]=i.number(o,qr[r]??1):t[r]=o;return t},Mt=(n,i)=>i.number(n,1),Ot=(n,i,e)=>{let t=Date.parse(n);return Number.isNaN(t)?0:Math.max(0,(e-i-t)/1e3)},cn=(n,i)=>n===null?0:Math.max(0,n-i),pn=(n,i)=>n===null||n<=0?0:Math.max(0,Math.min(1,i/n));var H="act:",ye="save:",be="pick:",Dt="submit",Ht="stop",Ft="claim",Nt="cue",qt="show:all",Wt="show:affected",Be="again",Bt="open_cover",te="close",Lt=["travel_cm","opening_time_s","closing_time_s"],Kr={repeat_step:"home_closed_done",not_right:"home_closed_done",accept_step:"open_result",repeat_tape:"tape_result",tape_not_right:"tape_result",repeat_measure:"height_result",path_c:"verify_result",refine:"summary_basic"},C=(n,i,e)=>{let t=n.t(i,e);return t===i?null:t},ie=(n,i,e,t)=>{let r=C(n,`options.step.${i}.menu_options.${e}`,t);if(r!==null)return r;let o=Kr[e];return(o?C(n,`options.step.${o}.menu_options.${e}`,t):null)??e},un=(n,i)=>{let e=n?.step,t=e?zt[e]:void 0;return t?.phase?i.t("panel.screen.phase",{phase:i.t(ln[t.phase]),index:Pt.indexOf(t.phase)+1,count:Pt.length}):null},qe=(n,i,e)=>{let t=n.find(r=>r.key===i);return t?{label:It(i,e),before:t.before===null?void 0:we(i,t.before,e),after:we(i,t.after,e)}:null},mn=(n,i)=>{let{i18n:e}=i,t=dn(n.placeholders,e);if(!n.cover||typeof n.cover.name!="string")throw new Error("the snapshot names no shutter");if(n.state==="saved"||n.state==="ended")return io(n,i,t);let r=n.step;if(!r)throw new Error(`a running session with no step (state ${n.state})`);let o=zt[r];if(!o)throw new Error(`no screen is described for the step '${r}'`);let s=o.template==="pos"?Qr(n,i,o,t):o.template==="riepilogo"?Jr(n,i,t):o.template==="esito"?to(n,i,o,t):Gr(n,i,o,r,t);return no(s,n,i),s},Gr=(n,i,e,t,r)=>{let{i18n:o}=i,s=e.display??t,l=C(o,`options.step.${s}.title`,r)??"",c=C(o,`options.step.${s}.description`,r)??"",{image:p,body:u}=kt(c),h={id:t,model:e.template,title:l,body:u,image:p?{src:p.src,alt:p.alt}:void 0};return e.template==="click"?jr(h,n,i,e,t,u,r):(e.template==="metro"||e.template==="controllo"&&n.form)&&Yr(h,n,i,t,r),(e.template==="scelta"||e.template==="controllo")&&(h.options=Xr(n,i,t,r)),n.check&&Vr(h,n,i),e.template==="metro"&&n.actions.length>0&&(h.secondary=n.actions.map(v=>({label:ie(o,t,v,r),action:`${H}${v}`,kind:"secondary"}))),h.primary||vn(h,n,i,t,r),e.cue&&(h.toggle={label:o.t("panel.wizard.cue.toggle"),checked:i.cue,action:Nt}),h},jr=(n,i,e,t,r,o,s)=>{let{i18n:l}=e,c=i.movement,p=c?C(l,`options.progress.${c.progress_action}`,s):null,u=c?.started_at??null,h=u?Ot(u,e.skewMs,e.now):0,v=o.split(/\n{2,}/).map(f=>f.trim()).filter(f=>f!==""),_=t.press==="moving"?v[v.length-1]??"":p??"";t.press==="moving"||t.press==="registered"?n.body=v.slice(0,-1).join(`

`):n.body="";let T=e.position===null?void 0:l.t("panel.wizard.motor.position",{percent:l.number(e.position,0)});if(t.press==="starting"){n.press={state:"starting",label:"",instruction:_,motor:l.t("panel.wizard.motor.starting"),position:T},n.primary={label:"…",action:"",disabled:!0,kind:"primary"},We(n,t,l);return}if(t.press==="registered"){let Qt=i.measured.lift?.pressed_at??null,Jt=Qt&&u?Math.max(0,(Date.parse(Qt)-Date.parse(u))/1e3):null;n.press={state:"registered",label:"",instruction:_,motor:l.t("panel.wizard.motor.stopped"),position:T,note:Jt===null?void 0:l.t("panel.wizard.press.registered_note",{seconds:Mt(Jt,l)})},n.primary={label:l.t("panel.wizard.press.registered"),action:"",disabled:!0,kind:"primary"},We(n,t,l);return}let X=i.actions[0];n.press={state:"moving",label:"",instruction:_,motor:l.t("panel.wizard.motor.moving",{seconds:Mt(h,l)}),position:T},X&&(n.primary={label:ie(l,r,X,s),action:`${H}${X}`,kind:"primary"}),n.secondary=i.actions.slice(1).map(f=>({label:ie(l,r,f,s),action:`${H}${f}`,kind:"secondary"})),We(n,t,l)},We=(n,i,e)=>{i.stoppable&&(n.secondary=[...n.secondary??[],{label:e.t("panel.wizard.action.stop"),action:Ht,kind:"text"}])},Vr=(n,i,e)=>{let{i18n:t}=e,r=i.check;if(!r)return;let o=t.number(r.fraction*100,0);if(r.gap_cm===null){n.title=t.t("panel.wizard.check.no_reference.title"),n.body=t.t("panel.wizard.check.no_reference.body",{cover:i.cover.name,measured:t.number(r.measured_cm,1),percent:o}),n.image=void 0;return}let s=[t.t("panel.wizard.check.measured",{measured:t.number(r.measured_cm,1),predicted:t.number(r.predicted_cm,1),percent:o})];r.threshold_cm!==null&&s.push(r.profile_check_cm===null?t.t("panel.wizard.check.threshold",{threshold:t.number(r.threshold_cm,0)}):t.t("panel.wizard.check.threshold_profile",{threshold:t.number(r.threshold_cm,0),profile:i.profile??"",accuracy:t.number(r.profile_check_cm,1)})),n.lines=s},Yr=(n,i,e,t,r)=>{let{i18n:o}=e,s=i.form;if(!s||s.kind==="choice")return;let l=s.field,c=C(o,`options.step.${t}.data.${l}`,r)??l,p=C(o,`options.step.${t}.data_description.${l}`,r)??void 0,u=s.suggested;n.field={label:c,hint:p,unit:s.unit??void 0,value:e.typed??"",placeholder:u==null?void 0:typeof u=="number"?o.number(u,1):u,error:s.error===null?void 0:C(o,`options.error.${s.error}`)??void 0,big:s.kind==="number",inputMode:s.kind==="text"?"text":"decimal"},n.primary={label:o.t("panel.wizard.action.submit"),action:Dt,kind:"primary"}},Xr=(n,i,e,t)=>{let{i18n:r}=i,o=n.form;return o?.kind==="choice"?(o.choices??[]).map(s=>Zr(s,i,o.suggested)):n.actions.map(s=>({title:ie(r,e,s,t),action:`${H}${s}`,current:n.intent?.scope!==void 0&&n.intent.scope===s}))},Zr=(n,i,e)=>{let{i18n:t}=i;if(n==="from_the_file")return{title:t.origin("from_the_file",null),meta:t.t("panel.wizard.profile.from_file"),action:`${be}${n}`,current:e===n};let r=i.profiles.find(c=>c.name===n),o=r?.reference_height??null,s=r?.measured_on_name??null,l=o===null?t.t("panel.wizard.profile.meta_no_reference"):s===null?t.t("panel.wizard.profile.meta",{reference:t.number(o,0)}):t.t("panel.wizard.profile.meta_measured",{reference:t.number(o,0),cover:s});return{title:n,meta:l,action:`${be}${n}`,current:e===n}},vn=(n,i,e,t,r)=>{let{i18n:o}=e;if(n.options&&n.options.length>0)return;let s=i.actions.map(c=>({label:ie(o,t,c,r),action:`${H}${c}`})),l=s[0];l&&(n.primary={...l,kind:"primary"},n.secondary=s.slice(1).map(c=>({...c,kind:"secondary"})))},Qr=(n,i,e,t)=>{let{i18n:r}=i,o=n.movement,s=o?C(r,`options.progress.${o.progress_action}`,t):null,l=o?.started_at??null,c=l?Ot(l,i.skewMs,i.now):0,p=o?.planned_s??null,u=cn(p,c),h={id:n.step??"",model:"pos",title:r.t("panel.wizard.positioning.title"),progress:{text:s??"",fraction:pn(p,c),eta:p===null?void 0:r.t("panel.wizard.positioning.remaining",{seconds:r.number(u,0)}),done:p!==null&&u<=0}};return We(h,e,r),h},Jr=(n,i,e)=>{let{i18n:t}=i,r=n.review;if(!r)throw new Error("a session in review with no review in it");let o=Lt.map(h=>qe(r.rows,h,t)).filter(h=>h!==null),s=["slat_time_s","opening_roll","closing_roll"].map(h=>qe(r.rows,h,t)).filter(h=>h!==null),l=[];r.accuracy_cm!==null&&r.check_fraction!==null?l.push(t.t("panel.wizard.review.accuracy_checked",{accuracy:t.number(r.accuracy_cm,1),percent:t.number(r.check_fraction*100,0)})):l.push(t.t("panel.wizard.review.accuracy_unchecked")),r.profile_exists&&r.profile_name&&l.push(t.t("panel.wizard.review.profile_exists",{profile:r.profile_name,count:r.affected.length})),r.name_clash==="file"&&r.profile_name&&l.push(t.t("panel.wizard.review.name_clash",{profile:r.profile_name})),l.push(t.t("panel.wizard.review.where",{cover:n.cover.name}));let c={id:n.step??"",model:"riepilogo",title:t.t("panel.wizard.review.title"),body:t.t("panel.wizard.review.intro",{cover:n.cover.name}),summary:{rows:o,more:i.showAll?s:void 0,sideEffects:i.showAll&&r.side_effects.length>0?{title:t.t("panel.wizard.review.side_effects"),rows:r.side_effects.map(h=>({label:It(h.key,t),before:h.before===null?void 0:we(h.key,h.before,t),after:we(h.key,h.after,t)}))}:void 0,affected:i.showAffected&&r.affected.length>0?r.affected.map(h=>({title:h.name,rows:Lt.map(v=>qe(h.rows,v,t)).filter(v=>v!==null)})):void 0,code:i.showAll?r.yaml:void 0,codeLabel:i.showAll?t.t("panel.wizard.review.yaml"):void 0,lines:l,disclose:eo(r.affected.length>0,i,t)}},[p,...u]=r.targets;return p&&(c.primary={...hn(p,r.profile_name,t),kind:"primary"}),c.secondary=[...u.map(h=>({...hn(h,r.profile_name,t),kind:"secondary"})),...n.actions.map(h=>({label:ie(t,"summary_basic",h,e),action:`${H}${h}`,kind:"text"}))],c},hn=(n,i,e)=>n==="profile"?{label:e.t("panel.wizard.review.save_profile",{profile:i??""}),action:`${ye}profile`}:{label:e.t("panel.wizard.review.save_cover_only"),action:`${ye}cover_only`},eo=(n,i,e)=>{let t=[{label:i.showAll?e.t("panel.common.action.hide_all"):e.t("panel.common.action.show_all"),action:qt,open:i.showAll}];return n&&t.push({label:i.showAffected?e.t("panel.wizard.review.affected_hide"):e.t("panel.wizard.review.affected_show"),action:Wt,open:i.showAffected}),t},to=(n,i,e,t)=>{let{i18n:r}=i,o=n.step,s=e.own?r.t("panel.wizard.problem.interrupted.title"):C(r,`options.step.${o}.title`,t)??"",l=e.own?r.t("panel.wizard.problem.interrupted.body"):C(r,`options.step.${o}.description`,t)??"",{image:c,body:p}=kt(l),u={id:o,model:"esito",outcome:"problem",title:s,body:p,image:c?{src:c.src,alt:c.alt}:void 0,alert:s};return vn(u,n,i,o,t),u},io=(n,i,e)=>{let{i18n:t}=i,r=n.outcome,o=r?.reason??"cancelled",s=n.cover.name,l={id:`outcome_${o}`,model:"esito",title:"",outcome:"cancelled"};if(o==="saved"){let c=t.origin(r?.origin??"measured",r?.profile??null);l.outcome="saved",l.title=t.t("panel.wizard.outcome.saved.title"),l.body=r?.profile?t.t("panel.wizard.outcome.saved.profile",{cover:s,profile:r.profile,origin:c}):t.t("panel.wizard.outcome.saved.cover",{cover:s,origin:c});let p=n.review;return p&&(l.summary={rows:Lt.map(u=>qe(p.rows,u,t)).filter(u=>u!==null)}),l.primary={label:t.t("panel.wizard.outcome.action.again"),action:Be,kind:"primary"},l.secondary=[{label:t.t("panel.wizard.outcome.action.open_cover"),action:Bt,kind:"secondary"},{label:t.t("panel.wizard.outcome.action.close"),action:te,kind:"text"}],l}return o==="cancelled"?(l.title=t.t("panel.wizard.outcome.cancelled.title"),l.body=t.t("panel.wizard.outcome.cancelled.body",{cover:s})):o==="expired"?(l.outcome="expired",l.title=t.t("panel.wizard.outcome.expired.title"),l.body=t.t("panel.wizard.outcome.expired.body",{cover:s})):o==="unloaded"?(l.outcome="expired",l.title=t.t("panel.wizard.outcome.unloaded.title"),l.body=t.t("panel.wizard.outcome.unloaded.body",{cover:s})):o==="left"?(l.title=t.t("panel.wizard.outcome.left.title"),l.body=t.t("panel.wizard.outcome.left.body")):(l.outcome="problem",l.title=t.t("panel.wizard.outcome.gone.title"),l.body=t.t("panel.wizard.outcome.gone.body",{cover:s})),l.primary={label:t.t("panel.wizard.outcome.action.again"),action:Be,kind:"primary"},l.secondary=[{label:t.t("panel.wizard.outcome.action.close"),action:te,kind:"text"}],l},no=(n,i,e)=>{let{i18n:t}=e;i.notice==="rehomed"?n.note={text:t.t("panel.wizard.external.rehomed"),tone:"info"}:i.notice==="reading_stale"?n.note={text:t.t("panel.wizard.external.reading"),tone:"error"}:i.external_move&&(n.note={text:t.t("panel.wizard.external.moved"),tone:"info"}),i.substate==="awaiting_endpoint"&&(n.alert=t.t("panel.wizard.announce.motor")),n.announce=n.title,e.readOnly&&(n.primary=void 0,n.secondary=void 0,n.options=void 0,n.field=void 0,n.toggle=void 0,n.summary&&(n.summary={...n.summary,disclose:void 0}),n.readOnly={text:t.t("panel.wizard.owner.other"),label:t.t("panel.wizard.owner.take"),action:Ft})};var fn={ask:null,service:!1},xe={for:null,answer:null,loading:!1,error:null,mode:"view",form:{},errors:{},preview:null,previewing:!1},$e={for:null,mode:"view",form:{},errors:{},newName:"",nameError:"",impact:null,impacting:!1},Y=n=>({entryId:null,overview:null,status:"loading",error:null,connection:"starting",route:n,search:"",room:"",announce:"",pending:[],order:null,drag:null,armed:null,dialog:null,review:!1,heights:{},heightsForced:!1,showAll:!1,preview:null,previewing:!1,applying:!1,snack:null,writeError:null,detail:xe,profile:$e,session:null,sessionError:null,wizardIntent:null,clientId:"",busy:fn,wizardExit:!1}),Ke={pending:[],order:null,heights:{},heightsForced:!1,preview:null,previewing:!1,review:!1,writeError:null},Ue=class{constructor(i){this._subscribers=new Set;this._state=Y(i)}get state(){return this._state}subscribe(i){return this._subscribers.add(i),()=>this._subscribers.delete(i)}set(i){this._state={...this._state,...i};for(let e of this._subscribers)e(this._state)}setOverview(i){let e=this.state.overview?.measuring??null,t=i.measuring,r=(this.state.overview?.session??null)!==null,o=i.session!==null,s=t===null||e===null||e.cover_unique_id!==t.cover_unique_id||r!==o;this.set({overview:i,entryId:i.entry_id,status:"ready",error:null,...t===null?{busy:fn}:s?{busy:{...this.state.busy,ask:null}}:{}})}setError(i){this.set({status:"error",error:i})}announce(i){this.set({announce:""}),this.set({announce:i})}};var k=m`:host{--myhome-text-on-primary: var(--text-primary-color, #ffffff);--myhome-text-on-accent: #1a1a1a;--myhome-snack-action: var( --snack-action-color, color-mix(in srgb, var(--myhome-accent) 40%, var(--myhome-background)) );--myhome-primary: var(--primary-color, #03a9f4);--myhome-accent: var(--accent-color, #ff9800);--myhome-text: var(--primary-text-color, #212121);--myhome-text-soft: var(--secondary-text-color, #727272);--myhome-text-off: var(--disabled-text-color, #bdbdbd);--myhome-background: var(--primary-background-color, #fafafa);--myhome-background-soft: var(--secondary-background-color, #e5e5e5);--myhome-card: var(--card-background-color, #ffffff);--myhome-divider: var(--divider-color, rgba(0, 0, 0, .12));--myhome-error: var(--error-color, #db4437);--myhome-warning: var(--warning-color, #ffa600);--myhome-success: var(--success-color, #43a047);--myhome-info: var(--info-color, #039be5);--myhome-header: var(--app-header-background-color, var(--primary-color, #03a9f4));--myhome-header-text: var(--app-header-text-color, #ffffff);--myhome-radius: var(--ha-card-border-radius, 12px);--myhome-shadow: var(--ha-card-box-shadow, 0 1px 4px rgba(0, 0, 0, .14));--myhome-primary-pastel: color-mix(in srgb, var(--myhome-primary) 20%, var(--myhome-card));--myhome-primary-faint: color-mix(in srgb, var(--myhome-primary) 10%, var(--myhome-card));--myhome-accent-pastel: color-mix(in srgb, var(--myhome-accent) 18%, var(--myhome-card));--myhome-error-pastel: color-mix(in srgb, var(--myhome-error) 12%, var(--myhome-card));--myhome-error-strong: color-mix(in srgb, var(--myhome-error) 14%, var(--myhome-card));--myhome-warning-pastel: color-mix(in srgb, var(--myhome-warning) 12%, var(--myhome-card));--myhome-success-pastel: color-mix(in srgb, var(--myhome-success) 12%, var(--myhome-card));--myhome-info-pastel: color-mix(in srgb, var(--myhome-info) 12%, var(--myhome-card));--myhome-primary-ink: color-mix(in srgb, var(--myhome-primary) 50%, var(--myhome-text));--myhome-error-ink: color-mix(in srgb, var(--myhome-error) 50%, var(--myhome-text));--myhome-warning-ink: color-mix(in srgb, var(--myhome-warning) 50%, var(--myhome-text));--myhome-success-ink: color-mix(in srgb, var(--myhome-success) 50%, var(--myhome-text));--myhome-info-ink: color-mix(in srgb, var(--myhome-info) 50%, var(--myhome-text));--myhome-text-soft-ink: color-mix(in srgb, var(--myhome-text-soft) 50%, var(--myhome-text));--myhome-field-border: color-mix(in srgb, var(--myhome-text-soft) 80%, var(--myhome-card));--myhome-drawing-paper: var(--myhome-drawing-surface, #ffffff);display:block;min-height:100%;color:var(--myhome-text);background:var(--myhome-background)}*,*:before,*:after{box-sizing:border-box}:host * :focus-visible{outline:2px solid var(--myhome-primary-ink);outline-offset:2px}@media(prefers-reduced-motion:reduce){:host *{animation-duration:.001ms!important;transition-duration:.001ms!important}}`,S=m`.card{background:var(--myhome-card);border-radius:var(--myhome-radius);box-shadow:var(--myhome-shadow)}`,R=m`.cta{min-height:48px;padding:0 24px;border-radius:24px;border:none;background:var(--myhome-primary);color:var(--myhome-text-on-primary);font:inherit;font-size:15px;font-weight:500;cursor:pointer}.cta.secondary{background:transparent;border:1px solid var(--myhome-primary-ink);color:var(--myhome-primary-ink)}.cta.text{background:transparent;border:none;color:var(--myhome-primary-ink);padding:0 12px}.cta.destructive{background:var(--myhome-error-strong);color:var(--myhome-error-ink)}.cta[disabled]{background:var(--myhome-background-soft);color:var(--myhome-text-off);cursor:default}.cta.compact{min-height:44px;padding:0 18px;border-radius:22px;font-size:14px}`,W=m`.field{height:44px;border-radius:8px;border:1px solid var(--myhome-field-border);background:var(--myhome-card);color:var(--myhome-text);padding:0 12px;font:inherit;font-size:14px}.field:disabled{color:var(--myhome-text-off)}`,ne=m`.sr-only{position:absolute;width:1px;height:1px;margin:-1px;padding:0;overflow:hidden;clip:rect(0 0 0 0);clip-path:inset(50%);white-space:nowrap;border:0}`;var ke=n=>a`<div class="sr-only" role="status" aria-live="polite" aria-atomic="true">${n}</div>`,_n=n=>a`<div class="sr-only" role="alert" aria-live="assertive" aria-atomic="true">${n}</div>`,$=n=>{requestAnimationFrame(()=>{let i=n();i&&i.focus()})},Ge=class{constructor(){this._source=null}remember(i){this._source=i instanceof HTMLElement?i:null}restore(){let i=this._source;this._source=null,i&&i.isConnected&&$(()=>i)}},B=class{constructor(){this._root=null;this._onKey=i=>{if(i.key!=="Tab"||!this._root)return;let e=gn(this._root);if(e.length===0){i.preventDefault(),this._root.focus();return}let t=e[0],r=e[e.length-1],o=Ut(this._root.getRootNode());i.shiftKey&&(o===t||o===this._root)?(i.preventDefault(),r.focus()):!i.shiftKey&&o===r&&(i.preventDefault(),t.focus())}}hold(i,e=!0){this.release(),this._root=i,i.addEventListener("keydown",this._onKey),e&&$(()=>gn(i)[0]??i)}release(){this._root?.removeEventListener("keydown",this._onKey),this._root=null}},ro='a[href], button:not([disabled]), input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])',gn=n=>{let i=[],e=t=>{for(let r of t.querySelectorAll("*"))r.matches(ro)&&i.push(r),r.shadowRoot&&e(r.shadowRoot)};return e(n),i.filter(t=>t.offsetParent!==null)},Ut=n=>{let i=n.activeElement;for(;i?.shadowRoot?.activeElement;)i=i.shadowRoot.activeElement;return i};var je=m`.sheet-backdrop{position:fixed;inset:0;background:#0006;z-index:50}.sheet{position:fixed;left:0;right:0;bottom:0;max-height:86vh;background:var(--myhome-card);color:var(--myhome-text);z-index:51;border-radius:16px 16px 0 0;box-shadow:var(--myhome-shadow);display:flex;flex-direction:column}@media(min-width:600px){.sheet{inset:0 0 0 auto;width:min(480px,100vw);max-height:none;border-radius:0}}.sheet .head{display:flex;align-items:center;gap:8px;padding:12px 16px;border-bottom:1px solid var(--myhome-divider)}.sheet .head h2{margin:0;font-size:18px;font-weight:500;flex:1;min-width:0}.sheet .head button{width:48px;height:48px;flex:0 0 48px;border:none;background:transparent;color:var(--myhome-text-soft);font-size:20px;cursor:pointer;border-radius:24px}.sheet .body{flex:1;overflow:auto;padding:16px;padding-bottom:calc(16px + env(safe-area-inset-bottom,0px))}`;var wn=[je,m`.sheet .head h2.named{font-size:19px;font-weight:700;color:var(--myhome-primary);overflow-wrap:anywhere}.sheet.drawer .body{padding:16px 16px 0;padding-bottom:calc(16px + env(safe-area-inset-bottom,0px));background:var(--myhome-background)}`],yn=n=>{let{i18n:i}=n,e=()=>{n.applying||n.onClose()};return a`
  ...
  >
    ${n}
  </button>`,bn=(n,i,e,t,r)=>a`<span class="body" data-banner-question>${i}</span>
    <span class="links">
      ${re(e,t,"confirm",!0)}
      ${re(n.t("panel.common.action.cancel"),r,"keep")}
    </span>`,$n=(n,i,e,t)=>{let r=i.measuring;if(!r)return d;let o=i.session!==null,s=o?n.t("panel.banner.measuring.panel_body",{cover:r.name}):e.service?n.t("panel.wizard.busy.service"):n.t("panel.banner.measuring.body",{cover:r.name});return a`<div
    class="measuring"
    role="status"
    aria-live="polite"
  ...
  >
    ...
    ${e.ask==="end_panel"?bn(n,n.t("panel.banner.measuring.end_panel_confirm",{cover:r.name}),n.t("panel.banner.measuring.action.stop"),t.endPanel,()=>t.ask(null)):e.ask==="end_other"?bn(n,n.t("panel.wizard.busy.end_other_confirm"),n.t("panel.wizard.busy.end_other"),t.endOther,()=>t.ask(null)):a`<span class="body">${s}</span>
            <span class="links">
  ...
  </div>`,zn=n=>{let{i18n:i}=n;return a`<div class="strip pending-bar">
    <span class="count"
  ...
  >
    ...
    <div class="sheet" role="dialog" aria-modal="true" aria-labelledby="review-title" data-focus-root>
      ...
      <div class="body" aria-busy=${n.previewing?"true":"false"}>
        ...
        ${t.map(({change:c,cover:p})=>{let u=e.get(c.cover),h=n.heights[c.cover],v=c.to!==null&&p.height===null,_=v?ve(h):null,T=_!==null&&(n.forced||(h??"")!==""),X=u&&u.problem===null?o.filter(f=>u.values[f]!==void 0&&p.values[f]!==void 0):[];return a`<section class="item">
            <div class="line">
            ...
            ${v?a`<label class="travel">
                  ...
                  ${T?a`<p class="field-error">
                        ${_==="missing_travel"?i.t("panel.review.travel.required"):Wn(i,p,_,c)}
                      </p>`:d}`:d}
  ...
  `};var nt=class extends w{constructor(){super();this._trap=new B;this._returnTo=null;this._returnToRow=null;this._onKey=e=>{if(e.key==="Escape"){if(this.state.drag){this._drag.cancel();return}if(this.state.armed){this.actions.arm(null);return}if(this.state.dialog){this.actions.dialog(null);return}this.state.review&&!this.state.applying&&this.actions.review(!1)}};this._flip=null;this._narrowQuery=typeof matchMedia=="function"?matchMedia("(max-width: 599px)"):null;this._onWidth=()=>this.requestUpdate();this._route=e=>{let t=De(e.unique_id,this.state.pending);return t?Vi(this.i18n,e.profile??null,t.to):""};this._onGrab=(e,t)=>{this._drag.press(e.unique_id,t)};this._onRowPress=(e,t)=>{this._narrow&&!this._locked&&this._drag.arm(e.unique_id,t)};this.i18n=new y,this.state=Y({view:"overview",params:{},path:"/"}),this.actions={},this._drag=new et({root:()=>this.renderRoot,blocked:()=>this._locked,narrow:()=>this._narrow,onArm:e=>{let t=this._cover(e);t&&this.actions.arm(t)},onStart:e=>{let t=this._cover(e);t&&(this._drag.ghost(t.name,this.renderRoot),this.actions.drag(t))},onOver:e=>this.actions.over(e),onEnd:e=>this._endDrag(e)})}static{this.properties={i18n:{attribute:!1},state:{attribute:!1},actions:{attribute:!1}}}static{this.styles=[k,S,R,W,tt,On,Fn,Ze,Dn,Bn,m`:host{display:block;background:transparent}.intro{margin:8px 0 4px;max-width:72ch}.intro p{margin:0 0 8px;line-height:1.55}.counts{margin:0 0 16px;color:var(--myhome-text-soft)}.controls{display:flex;gap:12px;align-items:center;flex-wrap:wrap;margin:0 0 16px}.controls .search{flex:1 1 220px;max-width:340px}.controls .spacer{flex:1 1 auto}.select-wrap{position:relative;display:inline-flex}.select-wrap:after{content:"";position:absolute;right:13px;top:50%;width:7px;height:7px;border-right:1.6px solid var(--myhome-text-soft);border-bottom:1.6px solid var(--myhome-text-soft);border-radius:1px;transform:translateY(-70%) rotate(45deg);pointer-events:none}select.field{appearance:none;padding-right:36px}a.cta{display:inline-flex;align-items:center;text-decoration:none}.welcome{max-width:640px;margin:48px auto;padding:32px}.welcome h2{margin:0 0 12px;font-size:22px;font-weight:500}.welcome p{margin:0 0 8px;line-height:1.55}.welcome .soft{color:var(--myhome-text-soft);margin-bottom:24px}.welcome .after{margin:12px 0 0;font-size:13px;color:var(--myhome-text-soft)}.notice{padding:16px;margin:16px 0;font-size:14px;line-height:1.55}.notice .actions{margin-top:12px}.groups{margin-bottom:96px}.groups.targeting{margin-bottom:120px}.drag-ghost{position:fixed;left:0;top:0;z-index:80;pointer-events:none;background:var(--myhome-card);color:var(--myhome-text);border:1px solid var(--myhome-primary-ink);border-radius:8px;box-shadow:var(--myhome-shadow);padding:10px 14px;font-size:14px;max-width:260px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}`]}connectedCallback(){super.connectedCallback(),window.addEventListener("keydown",this._onKey),this._narrowQuery?.addEventListener("change",this._onWidth)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this._onKey),this._narrowQuery?.removeEventListener("change",this._onWidth),this._drag.stop(),this._trap.release()}updated(e){if(this._locked){let t=this._drag.dragging!==null;this._drag.stop(),t&&this.actions.announce(this.i18n.t("panel.assign.announce.drag_cancelled"))}if(e.has("state")){let t=e.get("state");if(this._manageFocus(t),this._flip){let r=this._flip;this._flip=null,requestAnimationFrame(()=>Mn(this.renderRoot,r))}}}_beforeMove(){this._flip=In(this.renderRoot)}_manageFocus(e){let t=this.state.dialog!==null||this.state.review,r=(e?.dialog??null)!==null||(e?.review??!1);if(t&&!r){let o=this._activeElement();this._returnTo=o,this._returnToRow=o?.closest("[data-row]")?.getAttribute("data-row")??null,requestAnimationFrame(()=>{let s=this.renderRoot.querySelector("[data-focus-root]");s&&this._trap.hold(s)});return}if(!t&&r){this._trap.release();let o=this._returnTo,s=this._returnToRow;this._returnTo=null,this._returnToRow=null,requestAnimationFrame(()=>{((s?[...this.renderRoot.querySelectorAll("[data-row]")].find(p=>p.getAttribute("data-row")===s)?.querySelector(".handle"):null)??(o?.isConnected?o:null))?.focus()})}}_activeElement(){let e=this.renderRoot.activeElement;return e instanceof HTMLElement?e:null}get _overview(){return this.state.overview}get _locked(){return this._overview?.measuring!=null||this.state.applying}get _narrow(){return this._narrowQuery?.matches??!1}_cover(e){return this._overview?.covers.find(t=>t.unique_id===e)}get _covers(){let e=this._overview;return e?Xi(e,this.state.order):[]}get _rooms(){let e=new Set;for(let t of this._overview?.covers??[])t.area&&e.add(t.area);return Array.from(e).sort((t,r)=>t.localeCompare(r,this.i18n.language))}_matches(e){let t=this.state.search.trim().toLowerCase();return t&&!e.name.toLowerCase().includes(t)?!1:!this.state.room||e.area===this.state.room}_valuesLine(e){return e.missing||!e.values||e.values.opening_time===void 0?this.i18n.t("panel.overview.group.values_unknown"):this.i18n.t("panel.overview.group.values",{travel:e.reference_height===null?"?":this.i18n.number(e.reference_height,0),opening:this.i18n.number(e.values.opening_time,1),closing:this.i18n.number(e.values.closing_time,1),slat:this.i18n.number(e.values.slat_time,1)})}_provenanceLine(e){if(e.source==="yaml"||(this._overview?.covers??[]).some(l=>l.profile===e.name&&l.profile_from_file))return this.i18n.t("panel.overview.group.from_file");if(!e.measured_on)return this.i18n.t("panel.overview.group.provenance_missing");let r=e.measured_at?this.i18n.date(e.measured_at):"";if(!e.measured_on_name)return this.i18n.t("panel.overview.group.measured_on_gone",{date:r});let o=this.i18n.t("panel.overview.group.measured_on",{cover:e.measured_on_name,date:r}),s=(this._overview?.covers??[]).find(l=>l.unique_id===e.measured_on);if(s&&s.profile!==e.name){let l=s.profile??this.i18n.t("panel.overview.group.no_profile");o+=` · ${this.i18n.t("panel.profile.provenance_now_profile",{profile:l})}`}return o}get _groups(){let e=this._overview;if(!e)return[];let t=this._covers,r=s=>t.filter(l=>Le(l,this.state.pending)===s&&this._matches(l)),o=e.profiles.map((s,l)=>({key:s.name,id:`group-${l}`,title:this.i18n.t("panel.overview.group.profile",{profile:s.name}),values:this._valuesLine(s),provenance:this._provenanceLine(s),warning:s.missing?this.i18n.t("panel.overview.group.missing"):"",covers:r(s.name)}));return o.push({key:null,id:"group-none",title:this.i18n.t("panel.overview.group.no_profile"),values:this.i18n.t("panel.overview.group.no_profile_note"),provenance:"",warning:"",covers:r(null)}),o}_appendAtEnd(e,t){if(this.state.order===null||t===(e.profile??null))return;let r=this._covers;this.actions.setOrder(Zi(r.map(o=>o.unique_id),e.unique_id,r.filter(o=>Le(o,this.state.pending)===t).map(o=>o.unique_id)))}_endDrag(e){let t=this.state,r=t.drag,o=r?.insert??null,s=r?.over??null,l=r?this._cover(r.cover):void 0;if(this.actions.drag(null),!e||!l||s===null){r&&this.actions.announce(this.i18n.t("panel.assign.announce.drag_cancelled"));return}let c=Nn(s),p=this._covers.map(_=>_.unique_id),u=St(p,l.unique_id,o??{beforeId:null,afterId:null});this._beforeMove();let h=De(l.unique_id,t.pending),v=h?h.to:l.profile??null;if(c!==v){this.actions.setOrder(u),this.actions.assign(l,c);return}if(t.pending.length>0){this.actions.setOrder(u),this.actions.announce(this.i18n.t("panel.assign.announce.reordered"));return}this.actions.reorder(u)}_renderControls(){return a`<div class="controls">
    ...
    </section>`}_renderStrips(){let e=this.state;if(e.route.view!=="overview")return d;if(e.drag)return An(this.i18n,e.drag.over==="none");if(e.armed){let t=this._cover(e.armed);return Pn(this.i18n,t?.name??"",()=>this.actions.arm(null))}return e.applying?Qe(this.i18n):e.snack?Je(this.i18n,e.snack.message,e.snack.undoToken?()=>this.actions.undo():null):e.pending.length>0&&!e.review?zn({i18n:this.i18n,count:e.pending.length,locked:this._locked,lockedCover:this._overview?.measuring?.name??"",onDiscard:()=>{this._beforeMove(),this.actions.discardAll()},onReview:()=>this.actions.review(!0)}):d}_renderDialog(){let e=this.state.dialog?this._cover(this.state.dialog):void 0;return e?Hn({i18n:this.i18n,cover:e,profiles:this._overview?.profiles??[],current:Le(e,this.state.pending),onPick:t=>{this._beforeMove(),this._appendAtEnd(e,t),this.actions.assign(e,t)},onClose:()=>this.actions.dialog(null)}):d}_renderReview(){let e=this._overview;return!this.state.review||!e?d:Un({i18n:this.i18n,pending:this.state.pending,covers:new Map(e.covers.map(t=>[t.unique_id,t])),profiles:new Map(e.profiles.map(t=>[t.name,t])),preview:this.state.preview,previewing:this.state.previewing,heights:this.state.heights,forced:this.state.heightsForced,showAll:this.state.showAll,applying:this.state.applying,refusal:this.state.writeError?this.i18n.refusal(this.state.writeError.translation_key,this.state.writeError.translation_placeholders??{}):"",route:this._route,onHeight:(t,r)=>this.actions.height(t,r),onToggleShowAll:()=>this.actions.toggleShowAll(),onConfirm:()=>this.actions.confirm(),onClose:()=>this.actions.review(!1)})}render(){let e=this._overview;if(!e)return a`<p>${this.i18n.t("panel.common.loading")}</p>`;if(e.no_basic_covers)return a`<section class="card welcome">
...
>
  ...
  ${e}
</div>`;var oe=[...fe,...ge],at=class extends w{constructor(){super();this._onKey=e=>{if(!(e.key!=="Escape"||this.state.applying)&&this.state.dialog===null){if(this.state.detail.mode!=="view"){this.actions.mode("view");return}this.actions.back()}};this._focused="";this.i18n=new y,this.state=Y({view:"cover",params:{},path:"/"}),this.actions={}}static{this.properties={i18n:{attribute:!1},state:{attribute:!1},actions:{attribute:!1}}}static{this.styles=[k,S,R,W,tt,rt,Ye]}connectedCallback(){super.connectedCallback(),window.addEventListener("keydown",this._onKey)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this._onKey)}updated(){let e=this.state.detail,t=`${e.for??""}|${e.mode}`;if(t===this._focused)return;let r=this.renderRoot.querySelector("[data-heading]");r&&(this._focused=t,$(()=>r))}get _locked(){return this.state.overview?.measuring!=null||this.state.applying}get _cover(){return this.state.detail.answer?.cover??null}_fullLabel(e){return this.i18n.t(`options.step.calibration_edit.data.${e}`)}_label(e){return N(this._fullLabel(e))}_unit(e){let t=ee[e];return t?this.i18n.t(t):""}_number(e,t){return this.i18n.number(t,L[e]??D[e]?.decimals??1)}_problem(e,t){return this.i18n.refusal(t,{key:this._fullLabel(e),min:D[e]?.min??0,max:D[e]?.max??0,cover:this.state.detail.answer?.cover.name??""})}_destination(){let e=this.state.detail.answer?.forget;return e?e.falls_back_to==="profile"?this.i18n.t("panel.detail.destination.profile",{profile:e.profile??""}):e.falls_back_to==="file"?this.i18n.t("panel.detail.destination.file"):this.i18n.t("panel.detail.destination.defaults"):""}render(){let e=this.state.detail;return e.loading?Xe(this.i18n):e.answer?a`${this._head(e.answer.cover)}
    ...
    ${e.mode==="remove"?this._remove(e.answer.cover):d}`:a`<div class="card">
    ...
    </section>`}_view(e,t){let r=oe.map(c=>t.find(p=>p.key===c)).filter(c=>c!==void 0),o=e.has_own.length>0,s=o&&e.level!=="precise",l=(this.state.overview?.profiles??[]).length>0;return a`<section class="card">
        <h2 data-heading tabindex="-1">${this.i18n.t("panel.detail.values.title")}</h2>
        <p class="intro">${this.i18n.t("panel.detail.values.intro")}</p>
        <div class="rows">
          ${r.map(c=>this._valueRow(e,c))}
        </div>
      </section>
      <section class="card actions">
        ...
        ${e.profile?E({label:this.i18n.t("panel.overview.group.open"),note:this.i18n.t("panel.overview.group.profile",{profile:e.profile}),onClick:()=>this.actions.openProfile(e.profile)}):d}
        ${this._calibrateButton("panel.detail.action.measure_again","panel.detail.action.measure_again_note",{},"measure-again")}
        ${o?E({label:this.i18n.t("panel.detail.action.correct"),note:l?this.i18n.t("panel.detail.action.correct_note"):this.i18n.t("panel.detail.correct.needs_profile"),mark:"correct",disabled:!l,onClick:()=>this.actions.mode("correct")}):d}
        ${s?this._calibrateButton("panel.detail.action.thorough","panel.detail.action.thorough_note",{path:"path_c",scope:"points_only"},"thorough",l):d}
        ${o?E({label:this.i18n.t("panel.detail.action.remove"),destructive:!0,disabled:this._locked,onClick:()=>this.actions.mode("remove")}):d}
      </section>`}_valueRow(e,t){let r=t.origin==="own"?this.i18n.t("panel.detail.source.own"):t.origin==="profile"?this.i18n.t("panel.detail.source.profile",{profile:e.profile??""}):t.origin==="file"?this.i18n.t("panel.detail.source.file"):this.i18n.t("panel.detail.source.default");return Se(this._label(t.key),this._number(t.key,t.value),this._unit(t.key),r,t.own&&t.inherited_value!==null?this.i18n.t("panel.detail.edit.inherits",{value:this._number(t.key,t.inherited_value)}):null)}_calibrateButton(e,t,r,o,s=!0){let l=this._cover;return E({label:this.i18n.t(e),note:s?this.i18n.t(t):this.i18n.t("panel.detail.correct.needs_profile"),mark:o,disabled:l===null||!s,onClick:()=>{if(!l)return;let c=l.profile!==null&&!l.profile_missing?l.profile:void 0;this.actions.calibrate({cover:l.unique_id,name:l.name,...r,...r.path&&c?{profile:c}:{}})}})}_edit(e){let t=this.state.detail.form,r=oe.map(s=>e.find(l=>l.key===s)).filter(s=>s!==void 0),o=r.some(s=>x(s.key,t[s.key])!==null);return a`<section class="card">
      ...
      ${P(this.i18n.t("panel.common.action.cancel"),()=>this.actions.mode("view"),a`<button class="cta compact" type="button"
          ?disabled=${this._locked||r!==null||A(t)}
    ...
    ${t==="delete"?this._delete(e):d}`}_head(e){let r=(this.state.overview?.covers??[]).find(l=>l.unique_id===e.measured_on),o;e.measured_on&&e.measured_on_name&&e.measured_at?(o=this.i18n.t("panel.profile.provenance",{cover:e.measured_on_name,date:this.i18n.date(e.measured_at)}),r&&r.profile!==e.name&&(o+=` · ${r.profile?this.i18n.t("panel.profile.provenance_now_profile",{profile:r.profile}):this.i18n.t("panel.profile.provenance_now_none")}`)):e.measured_on&&e.measured_at?o=this.i18n.t("panel.overview.group.measured_on_gone",{date:this.i18n.date(e.measured_at)}):o=this.i18n.t("panel.profile.provenance_missing");let s=e.editable?this.i18n.t("panel.profile.stored"):this.i18n.t("panel.profile.from_file");return a`<section class="card">
      ...
      ${e.missing?a`<p class="warn" style="margin:12px 0 0">
            ...
            <div class="rows">
              ${se.map(r=>r==="reference_height"?e.reference_height===null?d:Se(this._label(r),this._number(r,e.reference_height),this._unit(r),"",null):e.values[r]===void 0?d:Se(this._label(r),this._number(r,e.values[r]),this._unit(r),"",null))}
            </div>
          </section>`}
      <section class="card">
      ...
      ${e.editable?a`<section class="card actions">
          ...
          </section>`:d}`}_follower(e){let r=O.every(o=>e.has_own.includes(o))?this.i18n.t("panel.profile.followers.measured"):e.has_own.length>0?this.i18n.t("panel.profile.followers.adjusted",{keys:this._ownKeys(e)}):this.i18n.t("panel.profile.followers.inherited");return a`<div class="row">
      <span class="what">
        <button
          class="cta text"
          type="button"
    ...
    </div>`}_edit(){let e=this._followers,t=this.state.profile.form,r=se.some(s=>x(s,t[s])!==null||A(t[s])),o=e.length===1?this.i18n.t("panel.profile.edit.reach_one"):this.i18n.t("panel.profile.edit.reach_all",{count:e.length});return a`<section class="card">
      ...
      <div class="fields">
        ${st(se,s=>s,He,()=>ot(this.i18n.t("panel.common.advanced.title"),this.i18n.t("panel.common.advanced.body")),s=>Re({label:this._label(s),value:t[s]??"",unit:this._unit(s),error:A(t[s])?this.i18n.t("panel.common.required"):(()=>{let l=x(s,t[s]);return l?this._problem(s,l):null})(),disabled:this.state.applying,onInput:l=>this.actions.field(s,l)}))}
      </div>
    ...
    </section>`}_impact(e,t){let r=O.every(l=>e.has_own.includes(l)),o=r?this.i18n.t("panel.profile.impact.state_measured"):e.has_own.length>0?this.i18n.t("panel.profile.impact.state_adjusted"):this.i18n.t("panel.profile.impact.state_inherited"),s;if(r)s=this.i18n.t("panel.profile.impact.no_change");else if(e.height===null)s=this.i18n.t("panel.profile.impact.no_travel");else if(t)s=this.i18n.t("panel.profile.impact.invalid");else{let l=(this.state.profile.impact??[]).find(c=>c.cover_unique_id===e.unique_id);if(!l||l.problem!==null)s=this.i18n.t("panel.common.loading");else if(s=O.filter(p=>!e.has_own.includes(p)&&e.values[p]!==void 0&&l.values[p]!==void 0).map(p=>`${N(this.i18n.t(`options.step.calibration_edit.data.${p}`))} ${this._number(p,e.values[p])} → `+j(this._number(p,l.values[p]),this._unit(p))).join(" · "),e.has_own.length>0){let p=this.i18n.t("panel.profile.impact.kept",{keys:this._ownKeys(e)});s=s?`${s} — ${p}`:p}}return a`<div class="row">
    ...
    </section>`}};customElements.get("myhome-profile-card")||customElements.define("myhome-profile-card",lt);var Gn="myhome-calibration-cue",jn=()=>{try{return globalThis.localStorage??null}catch{return null}},Vn=(n=jn())=>{try{return n?.getItem(Gn)!=="off"}catch{return!0}},Yn=(n,i=jn())=>{try{i?.setItem(Gn,n?"on":"off")}catch{}},uo=()=>{let n=globalThis.AudioContext;if(!n)return!1;let i=new n,e=i.createOscillator(),t=i.createGain();return e.type="sine",e.frequency.value=880,t.gain.value=.25,e.connect(t),t.connect(i.destination),e.start(),e.stop(i.currentTime+.08),setTimeout(()=>{try{i.close()}catch{}},200),!0},Xn=n=>{if(!n)return!1;let i=!1;try{let e=globalThis.navigator?.vibrate;typeof e=="function"&&(e.call(globalThis.navigator,80),i=!0)}catch{}try{i=uo()||i}catch{}return i};var Zn=(n,i)=>n.summary?.note?a`<div class="stub">${n.summary.note}</div>`:d;var Qn=(n,i)=>{let e=n.options??[];return e.length===0?d:a`<div class="options" role="group" aria-label=${n.title}>
    ${e.map(t=>a`<button
        class="option"
        type="button"
      ...
      >
        <span class="option-head">
          ...
          ${t.chip?a`<span class="chip ${t.chipTone??"neutral"}"
                >${t.chipTone==="adjusted"?a`<span class="dot" aria-hidden="true"></span>`:d}${t.chip}</span
              >`:d}
        </span>
        ${t.meta?a`<span class="option-meta">${t.meta}</span>`:d}
      </button>`)}
  </div>`};var Jn=(n,i)=>{let e=n.progress;if(!e)return d;let t=Math.max(0,Math.min(1,e.fraction))*100;return a`<div class="progress-card">
  ...
  </div>`};var er=(n,i)=>{let e=n.press;if(!e)return d;let t=e.state==="moving";return a`
  ...
  `};var mo=n=>{let i=[n.hint?"gap-hint":"",n.error?"gap-error":""].filter(e=>e!=="");return i.length>0?i.join(" "):void 0},tr=(n,i)=>{let e=n.options??[],t=n.field;return e.length===0&&!t?d:a`
  ...
  `};var vo=n=>{let i=[n.hint?"reading-hint":"",n.error?"reading-error":""].filter(e=>e!=="");return i.length>0?i.join(" "):void 0},ir=(n,i)=>{let e=n.field;return e?a`<div class="reading ${e.big===!1?"":"big"}">
...
`,nr=(n,i)=>a`
  <div class="summary-group">
    ...
    <div class="summary">${n.rows.map(e=>Vt(e,i))}</div>
  </div>
`,rr=(n,i)=>{let e=n.summary;return e?a`
    <div class="summary">
      ${e.rows.map(t=>Vt(t,i))}
      ${(e.more??[]).map(t=>Vt(t,i))}
    ...
    ${e.sideEffects?nr(e.sideEffects,i):d}
    ${(e.affected??[]).map(t=>nr(t,i))}
  ...
  `:d};var or=(n,i)=>n.summary?.rows?.length?a`<div class="summary">
    ...
    </div>`}render(){let e=this.model;if(!e)return d;let t={i18n:this.i18n,fire:this._fire},r=e.model==="pos",o=e.image?wi(e.image):null,s=(e.image?.alt??"")!=="";return a`<div class="screen">
  ...
  `};var _o={refresh:()=>{},act:()=>{},stop:()=>{},save:()=>{},cancel:()=>{},claim:()=>{},claimAndCancel:()=>{},force:()=>{},exit:()=>{},again:()=>{},start:()=>{},endOther:()=>{},ask:()=>{},openFlow:()=>{},openCover:()=>{},back:()=>{}},wo=100,pr="pick",dt=class extends w{constructor(){super();this._broken=null;this._reported=!1;this._typed=null;this._typedFor="";this._showAll=!1;this._showAffected=!1;this._cue=Vn();this._skewMs=0;this._skewFor="";this._clock=null;this._painted=0;this._focusedFor="";this._signalledFor="";this._askedFor=null;this._trap=new B;this._return=new Ge;this._trapped=!1;this._onKey=e=>{e.key==="Escape"&&this.state.session&&(e.stopPropagation(),this.actions.exit(!this.state.wizardExit))};this._onScreenAction=e=>{let t=e.detail,r=t?.action??"",o=t?.value;if(r==="field"){this._typed=o??"";return}if(r===Dt){this.actions.act("submit",this._typed??"");return}if(r.startsWith(be)){this.actions.act("submit",r.slice(be.length));return}let s=ar(r);if(s!==null){let l=(this.state.overview?.covers??[]).find(c=>c.unique_id===s);this.actions.start({cover:s,name:l?.name});return}if(r.startsWith(H)){this.actions.act(r.slice(H.length));return}if(r.startsWith(ye)){this.actions.save(r.slice(ye.length));return}if(r===Ht){this.actions.stop();return}if(r===Ft){this.actions.claim();return}if(r===Nt){this._cue=o!=="off",Yn(this._cue),this.requestUpdate();return}if(r===qt){this._showAll=!this._showAll,this.requestUpdate();return}if(r===Wt){this._showAffected=!this._showAffected,this.requestUpdate();return}if(r===Be){this.actions.again();return}if(r===Bt){let l=this.state.session?.cover?.unique_id;l&&this.actions.openCover(l);return}r===te&&this.actions.back()};this.i18n=new y,this.state={},this.actions=_o,this.hass=null}static{this.properties={i18n:{attribute:!1},state:{attribute:!1},actions:{attribute:!1},hass:{attribute:!1}}}static{this.styles=[k,S,R,ne,dr,m`:host{display:block}.card{padding:16px}.card+.card{margin-top:16px}.card.problem{background:var(--myhome-error-pastel)}h2{margin:0 0 8px;font-size:18px}.actions{display:flex;flex-wrap:wrap;gap:8px;margin-top:16px}.soft{color:var(--myhome-text-soft);font-size:13px;margin-top:8px}`]}connectedCallback(){super.connectedCallback(),this.addEventListener("keydown",this._onKey)}disconnectedCallback(){this.removeEventListener("keydown",this._onKey),this._stopClock(),this._trap.release(),this._trapped=!1,super.disconnectedCallback()}render(){if(this._broken)return this._renderBroken();try{return a`${this._renderSession()}${this._renderTrouble()}${this._renderExit()}`}catch(e){return this._fail(e),this._renderBroken()}}updated(){let e=this.state.session??null;if(this._followClock(e),this._followExit(),this._followBusy(),this._broken)return;if(!e){if(this._focusedFor!==pr){this._focusedFor=pr;let o=this.shadowRoot?.querySelector("myhome-screen");o?.updateComplete.then(()=>o.focusEntry("title"))}return}let t=`${e.session_id}:${e.state}:${e.step??""}`;if(t!==this._focusedFor){this._focusedFor=t;let o=this.shadowRoot?.querySelector("myhome-screen"),s=e.substate==="awaiting_endpoint"?"primary":"title";o?.updateComplete.then(()=>o.focusEntry(s))}let r=`${e.session_id}:${e.substate==="awaiting_endpoint"?e.step:""}`;e.substate==="awaiting_endpoint"&&r!==this._signalledFor&&(this._signalledFor=r,Xn(this._cue))}_renderSession(){let e=this.state.session??null;if(!e)return this._renderPick();this._rememberField(e);let t=mn(e,{i18n:this.i18n,now:Date.now(),skewMs:this._skew(e),typed:this._typed,position:this._position(e),readOnly:this._readOnly(e),showAll:this._showAll,showAffected:this._showAffected,cue:this._cue,profiles:this.state.overview?.profiles??[]});return a`<div data-wizard>
      ${ke(t.announce??"")}${_n(t.alert??"")}
      <myhome-screen
        .model=${t}
        .i18n=${this.i18n}
      ...
      </div>`;let t=lr(this.i18n,e);return a`<div data-wizard-pick>
      ${this.state.overview?.measuring?this._renderBusy(null):d}
      ${ke(t.announce??"")}
      <myhome-screen
        .model=${t}
        .i18n=${this.i18n}
    ...
    </div>`}_renderBusy(e){let t=e?.error.translation_placeholders??{},r=this.state.overview?.measuring??null,o=t.cover??r?.name??this.state.wizardIntent?.name??"",s=this.state.busy.service?"reserved":e===null?this.state.overview?.session?"panel":"other":t.by??"reserved",l=this.state.overview?.session?.owner===this.state.clientId,c=s==="panel"?l?this.i18n.t("panel.wizard.busy.here",{cover:o}):this.i18n.t("panel.wizard.busy.panel",{cover:o}):s==="other"?this.i18n.t("panel.wizard.busy.other",{cover:o}):this.i18n.t("panel.wizard.busy.service");return this.state.busy.ask==="end_other"?a`<div class="card problem" role="alert" data-session-busy>
    ...
    ></myhome-screen>`}get _locked(){let e=this._store.state;return e.overview?.measuring!=null||e.applying}async _confirm(){let e=this._store.state,t=e.entryId;if(this._locked||!t||e.pending.length===0)return;if(e.pending.filter(l=>{let c=e.overview?.covers.find(p=>p.unique_id===l.cover);return c!==void 0&&Qi(c,l)&&ve(e.heights[l.cover])!==null}).length>0){this._store.set({heightsForced:!0}),this._store.announce(this._i18n.t("panel.assign.announce.missing_travel"));return}let o=Rt(e.pending,e.heights,e.overview?.covers??[]),s=e.order??void 0;this._store.announce(this._i18n.t("panel.assign.announce.applying")),await this._write(()=>Si(this.hass.connection,t,o,s),l=>{this._store.set({...Ke}),this._store.setOverview(l.overview),this._snack(l.applied===1?this._i18n.t("panel.toast.assigned_one"):this._i18n.t("panel.toast.assigned",{count:l.applied}),l.undo_token)})}async _undo(){let e=this._store.state,t=e.snack?.undoToken;if(!t||!e.entryId)return;let r=e.entryId;this._clearSnack(),await this._write(()=>Ii(this.hass.connection,r,t),o=>{this._store.setOverview(o.overview),this._snack(this._i18n.t("panel.toast.undone"),null)})}async _write(e,t,r){this._store.set({applying:!0,writeError:null});try{let o=await e();this._store.set({applying:!1}),t(o)}catch(o){let s=b(o);this._store.set({applying:!1,writeError:s});let l=this._i18n.refusal(s.translation_key,s.translation_placeholders??{});this._store.announce(l),r?.(l)}}_snack(e,t,r=!0){this._clearSnack(),this._store.set({snack:{message:e,undoToken:t}}),r&&this._store.announce(e),this._snackTimer=setTimeout(()=>{this._snackTimer=null,this._store.set({snack:null})},bo)}_clearSnack(){this._snackTimer&&(clearTimeout(this._snackTimer),this._snackTimer=null),this._store.set({snack:null})}_schedulePreview(){this._store.state.review&&(this._previewTimer&&clearTimeout(this._previewTimer),this._previewTimer=setTimeout(()=>{this._previewTimer=null,this._refreshPreview()},Xt))}async _refreshPreview(){let e=this._store.state;if(!e.entryId||e.pending.length===0){this._store.set({preview:null});return}let t=++this._previewSeq;this._store.set({previewing:!0});try{let r=await Me(this.hass.connection,e.entryId,Rt(e.pending,e.heights,e.overview?.covers??[]));t===this._previewSeq&&this._store.set({preview:r.items,previewing:!1})}catch(r){t===this._previewSeq&&this._store.set({previewing:!1}),me(r)||console.warn("MyHOME panel: the preview could not be read",b(r))}}get _detailCover(){let e=this._store.state,t=e.detail.for;return e.overview?.covers.find(r=>r.unique_id===t)??null}async _loadDetail(){let e=this._store.state,t=e.detail.for;if(!(!this._started||!this.hass||!t||!e.entryId))try{let r=await $i(this.hass.connection,e.entryId,t);if(this._store.state.detail.for!==t)return;this._store.set({detail:{...this._store.state.detail,answer:r,loading:!1,error:null}})}catch(r){if(this._store.state.detail.for!==t)return;this._store.set({detail:{...this._store.state.detail,answer:null,loading:!1,error:b(r)}})}}_detailForm(){let e=this._store.state.detail.answer,t={};for(let r of oe){let o=e?.keys.find(s=>s.key===r);t[r]=o&&o.own?this._i18n.number(o.value,L[r]??1):""}return t}async _saveValues(){let e=this._store.state,t=e.detail.for;if(this._locked||!t||!e.entryId)return;let r={};for(let c of oe){let p=e.detail.form[c];if(x(c,p)!==null)return;r[c]=A(p)?null:M(p??"")}let o=Object.values(r).every(c=>c===null),s=this._detailCover?.name??"",l=e.entryId;await this._write(()=>Ti(this.hass.connection,l,t,r),c=>{this._store.set({detail:{...this._store.state.detail,mode:"view",form:{}}}),this._store.setOverview(c.overview),this._loadDetail(),this._snack(o?this._i18n.t("panel.toast.measure_removed",{cover:s,destination:this._destinationOf(c.overview,t)}):this._i18n.t("panel.toast.values_saved",{cover:s}),c.undo_token)})}async _saveTravel(){let e=this._store.state,t=e.detail.for,r=e.detail.form.height;if(this._locked||!t||!e.entryId||A(r)||x("height",r))return;let o=M(r??""),s=this._detailCover?.name??"",l=e.entryId;await this._write(()=>Ei(this.hass.connection,l,t,o),c=>{this._store.set({detail:{...this._store.state.detail,mode:"view",form:{},preview:null}}),this._store.setOverview(c.overview),this._loadDetail(),this._snack(this._i18n.t("panel.toast.travel_saved",{cover:s}),c.undo_token)})}async _removeMeasure(){let e=this._store.state,t=e.detail.for;if(this._locked||!t||!e.entryId)return;let r=this._detailCover?.name??"",o=e.entryId;await this._write(()=>Ci(this.hass.connection,o,t),s=>{this._store.set({detail:{...this._store.state.detail,mode:"view"}}),this._store.setOverview(s.overview),this._loadDetail(),this._snack(this._i18n.t("panel.toast.measure_removed",{cover:r,destination:s.falls_back_to==="profile"?this._i18n.t("panel.detail.destination.profile",{profile:s.profile??""}):s.falls_back_to==="file"?this._i18n.t("panel.detail.destination.file"):this._i18n.t("panel.detail.destination.defaults")}),s.undo_token)})}_destinationOf(e,t){let r=e.covers.find(o=>o.unique_id===t);return r?.origin==="inherited"||r?.origin==="adjusted"?this._i18n.t("panel.detail.destination.profile",{profile:r.profile??""}):r?.origin==="from_the_file"?this._i18n.t("panel.detail.destination.file"):this._i18n.t("panel.detail.destination.defaults")}_scheduleTravelPreview(){this._travelTimer&&clearTimeout(this._travelTimer),this._travelTimer=setTimeout(()=>{this._travelTimer=null,this._refreshTravelPreview()},Xt)}async _refreshTravelPreview(){let e=this._store.state,t=this._detailCover,r=e.detail.form.height;if(!e.entryId||!t||A(r)||x("height",r)!==null){this._store.set({detail:{...this._store.state.detail,preview:null}});return}let o=++this._previewSeq;this._store.set({detail:{...this._store.state.detail,previewing:!0}});try{let s=await Me(this.hass.connection,e.entryId,[{...Et(t),height:M(r??"")}]);if(o!==this._previewSeq)return;this._store.set({detail:{...this._store.state.detail,preview:s.items[0]??null,previewing:!1}})}catch(s){o===this._previewSeq&&this._store.set({detail:{...this._store.state.detail,previewing:!1}}),me(s)||console.warn("MyHOME panel: the preview could not be read",b(s))}}_openFlow(e){en({source:e,entryId:this._store.state.entryId,onLeaving:()=>this._store.announce(this._i18n.t("panel.common.opens_configure"))})}_drawerTitle(){let e=this._store.state,t=e.route;if(t.view==="cover"){let r=this._detailCover;return r?r.name:this._i18n.t("panel.detail.title")}return t.view==="profile"?e.overview?.profiles.some(o=>o.name===t.params.name)?this._i18n.t("panel.profile.name",{profile:t.params.name}):this._i18n.t("panel.profile.title"):this._i18n.t("panel.overview.title")}_title(){let e=this._store.state;return e.route.view==="calibrate"?e.session?.cover?.name??e.wizardIntent?.name??this._i18n.t("panel.wizard.title"):this._i18n.t("panel.overview.title")}get _profileRow(){let e=this._store.state;return e.overview?.profiles.find(t=>t.name===e.profile.for)??null}_followersOf(e){let t=this._store.state.overview?.covers??[];if(!e)return[];let r=new Set([...e.followers,...e.followers_from_file]);return t.filter(o=>r.has(o.unique_id))}_profileForm(e){let t={};for(let r of se){let o=r==="reference_height"?e?.reference_height:e?.values[r];t[r]=o==null?"":this._i18n.number(o,L[r]??0)}return t}_typedProfile(){let e=this._store.state.profile.form,t={};for(let r of se){if(A(e[r])||x(r,e[r])!==null)return null;t[r]=M(e[r]??"")}return t}async _saveProfile(){let e=this._store.state,t=e.profile.for,r=this._typedProfile();if(this._locked||!t||!e.entryId||!r)return;let{reference_height:o,...s}=r,l=e.entryId;await this._write(()=>Ai(this.hass.connection,l,t,s,o),c=>{this._store.set({profile:{...this._store.state.profile,mode:"view",impact:null}}),this._store.setOverview(c.overview),this._snack(c.affected.length===1?this._i18n.t("panel.toast.profile_saved_one",{profile:t}):this._i18n.t("panel.toast.profile_saved",{profile:t,count:c.affected.length}),c.undo_token)})}async _renameProfile(){let e=this._store.state,t=e.profile.for,r=e.profile.newName.trim();if(this._locked||!t||!e.entryId||!r||r===t)return;let o=e.entryId;await this._write(()=>Pi(this.hass.connection,o,t,r),s=>{this._store.setOverview(s.overview),this._navigate(`/profile/${encodeURIComponent(r)}`),this._snack(this._i18n.t("panel.toast.profile_renamed",{profile:r}),s.undo_token)},s=>this._store.set({profile:{...this._store.state.profile,nameError:s},writeError:null}))}async _deleteProfile(){let e=this._store.state,t=e.profile.for;if(this._locked||!t||!e.entryId)return;let r=e.entryId;await this._write(()=>zi(this.hass.connection,r,t),o=>{this._store.setOverview(o.overview),this._navigate("/"),this._snack(this._i18n.t("panel.toast.profile_deleted",{profile:t}),o.undo_token)})}_scheduleImpact(){this._impactTimer&&clearTimeout(this._impactTimer),this._impactTimer=setTimeout(()=>{this._impactTimer=null,this._refreshImpact()},Xt)}async _refreshImpact(){let e=this._store.state,t=this._typedProfile(),r=e.profile.for,o=this._followersOf(this._profileRow);if(!e.entryId||!r||!t||o.length===0){this._store.set({profile:{...this._store.state.profile,impact:null}});return}let s=++this._previewSeq;this._store.set({profile:{...this._store.state.profile,impacting:!0}});try{let l=await Me(this.hass.connection,e.entryId,o.map(c=>Et(c)),{[r]:t});if(s!==this._previewSeq)return;this._store.set({profile:{...this._store.state.profile,impact:l.items,impacting:!1}})}catch(l){s===this._previewSeq&&this._store.set({profile:{...this._store.state.profile,impacting:!1}}),me(l)||console.warn("MyHOME panel: the impact preview could not be read",b(l))}}async _retry(){await this._refresh(),this._store.state.connection!=="live"&&await this._listen()}_ensureSession(){let e=this._store.state.entryId;if(!e||!this.hass)return null;if(this._sessionClient&&this._sessionClient.entryId===e)return this._sessionClient;this._release(this._sessionClient);let t=new Ne({connection:this.hass.connection,entryId:e,onChange:r=>this._store.set({session:r})});return this._sessionClient=t,this._store.set({clientId:t.clientId,session:t.session}),t}async _readSession(){let e=this._ensureSession();if(!e)return;let t=await e.get();if(!t.ok){this._store.set({sessionError:t});return}if(!t.session||_e(t.session)){this._store.set({sessionError:null});return}let r=await e.attach(t.session.session_id);this._store.set({sessionError:r.ok?null:r})}_leaveSession(){let e=this._sessionClient;!e||!e.session||e.leave()}async _calibrate(e){if(this._store.set({wizardIntent:e,sessionError:null}),!e){this._navigate("/calibrate"),this._store.state.route.view==="calibrate"&&this._readSession();return}let t=this._ensureSession();if(this._openingSession=!0,this._navigate("/calibrate"),!t)return;let r=await t.start(e);this._store.set({sessionError:r.ok?null:r})}async _takeControl(){let e=this._ensureSession();if(!e)return;let t=await e.takeControl();this._store.set({sessionError:t.ok?null:t})}async _cancelSession(e){let t=this._ensureSession();if(!t)return;let r=e==="claim"?await t.claimAndCancel():await t.cancel({force:e==="force"});if(r.ok||!r.error){this._store.set({sessionError:null,wizardIntent:null});return}this._store.set({sessionError:{error:r.error,recovery:r.recovery,freedAt:r.freedAt}})}async _actSession(e,t){let r=this._ensureSession();if(!r)return;let o=await r.act(e,t);this._store.set({sessionError:o.ok?null:o})}async _stopSession(){let e=this._ensureSession();if(!e)return;let t=await e.stop();this._store.set({sessionError:t.ok?null:t})}async _saveSession(e){let t=this._ensureSession();if(!t)return;let r=await t.save(e);if(!r.ok){this._store.set({sessionError:r});return}this._store.set({sessionError:null,wizardIntent:null,...r.overview?{overview:r.overview}:{}})}async _endOther(){let e=this._ensureSession();if(!e)return;this._store.set({busy:{...this._store.state.busy,ask:null}});let t=await e.endOther();if(!t.ok){this._store.set({sessionError:t});return}t.overview&&this._store.setOverview(t.overview),this._store.set({busy:{ask:null,service:t.stillCalibrating},...t.stillCalibrating?{}:{sessionError:null}})}_renderView(){let e=this._store.state;if(e.status==="loading")return Cn(this._i18n);if(e.status==="error"||!e.overview){let r=e.error;return a`<div class="card problem" role="alert">
        ...
        <div class="soft">
          ...
          <a href=${q}>${this._i18n.t("panel.common.action.configure")}</a>
    ...
    ></myhome-overview>`}_renderWizard(){try{return a`<myhome-wizard
      ...
      ></myhome-wizard>`}catch(e){return console.error("MyHOME panel: the guided calibration could not be drawn",e),a`<div class="card problem" role="alert">
        ...
        <div class="soft">
          ...
          <a href=${q}>${this._i18n.t("panel.common.action.configure")}</a>
      ...
      </div>`}}_renderDrawer(){let e=this._store.state;if(!V(e.route)||e.status==="error")return d;let t=e.status==="loading"?Xe(this._i18n):e.route.view==="cover"?a`<myhome-cover-detail
              .i18n=${this._i18n}
              .state=${e}
            ...
            ></myhome-profile-card>`;return yn({i18n:this._i18n,title:this._drawerTitle(),hasBack:this._drawerBack!==null,applying:e.applying,onClose:this._closeDrawer,content:t})}render(){let e=this._store.state,t=this._title(),r=e.route.view!=="overview";return a`
      <!--
      ...
      -->
      ${e.overview&&e.route.view!=="calibrate"?$n(this._i18n,e.overview,e.busy,this._bannerActions):d}
      <div class="content">
      ...
      -->
      ${r&&e.applying?Qe(this._i18n):d}
      ${r&&e.snack&&!e.applying?Je(this._i18n,e.snack.message,e.snack.undoToken?()=>{this._undo()}:null):d}
      </div>
    `}_renderTitle(e){let t=this._store.state,r=t.route.view==="calibrate"?un(t.session??null,this._i18n):null;return r?a`<div class="titles">
